            ...
            <td width="610"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="3">
                      <tr>
                        <td><font size="3" face="Arial, Helvetica, sans-serif"><strong>Checking Out: <%=trim(rsCart("chrCart"))%></strong></font></td>
                      ...
                      <tr bgcolor="#f5f5f5">
                        <td colspan="2"><font size="1" face="Arial, Helvetica, sans-serif">To check out an asset please scan the UPC code or type in the Asset Number.<br>
						    <font color="#FF0000">The right hand section will update each time an asset is checked out.</font></font></td>
                      </tr>
                    </table></td>
                </tr>
                <tr>
                  ...
                  <td bgcolor="#5b5b5b"><table width="100%" border="0" cellspacing="1" cellpadding="0">
                      <tr bgcolor="#f5f5f5">
						  ...
						  <table width="100%" border="0" cellspacing="0" cellpadding="5">
                            ...
                            <tr>
                              <td align="center"><font size="1" face="Arial, Helvetica, sans-serif">
                                <input name="Submit" type="submit" onClick="YY_checkform('form1','chrAssNum','#q','0','Please scan the Asset.');return document.MM_returnValue" value="Check Out">
                                </font></td>
                            </tr>
                          </table></td>
                        <td width="50%"><table width="100%" border="0" cellspacing="0" cellpadding="5">
                            ...
                            <tr>
                              <td><font size="2" face="Arial, Helvetica, sans-serif">Assets Ordered</font></td>
                              <td><strong><font color="#0000FF" size="2" face="Arial, Helvetica, sans-serif"><%=rsCart("intOrdered")%></font></strong></td>
                            </tr>
                            <tr>
                              <td><font size="2" face="Arial, Helvetica, sans-serif">Assets Scanned</font></td>
                              <td><strong><font color="#0000FF" size="2" face="Arial, Helvetica, sans-serif"><%=rsCart("intScanned")%></font></strong></td>
                            </tr>
                            <tr>
                              <td><font size="2" face="Arial, Helvetica, sans-serif">Assets Left</font></td>
                              <td><strong><font color="#0000FF" size="2" face="Arial, Helvetica, sans-serif"><%=rsCart("intOrdered") - rsCart("intScanned")%></font></strong></td>
                            </tr>
                          </table></td>
                      </tr>
                    </table></td>
