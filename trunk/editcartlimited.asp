...
<form name="form1" method="post" action="precheckupdatecartlimited.asp">
            ...
            <td width="610"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr> 
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="3">
                      ...
                      <tr> 
                        <td width="50%"><font size="1" face="Arial, Helvetica, sans-serif">Arrival Time (if applicable) (example: 9:00 AM)<br>
                          <input name="dtArrivalTime" type="text" id="dtArrivalTime" size="12" maxlength="10" value="<%=formatdatetime(rsCart("dtArrivalTime"),4)%>"></font></td>
                        <td width="50%"><font size="1" face="Arial, Helvetica, sans-serif">End / Departure Time (if applicable) (example: 9:00 AM)<br>
                          <input name="dtDepartureTime" type="text" id="dtDepartureTime" size="12" maxlength="10" value="<%=formatdatetime(rsCart("dtDepartureTime"),4)%>"></font></td>
                      </tr>
                    </table></td>
                </tr>
                <tr> 
...
%>
                <tr> 
                  <td><input name="Submit" type="submit" onClick="YY_checkform('form1',<%=addressjavastring%><%=carrierjavastring%>'chrOrder','#q','0','Please enter the Order Name.','chrDDName','#q','0','Please enter the Division/Department Name.','chrDDNumber','#q','0','Please enter the Division/Department Number.','chrOSPerson','#q','0','Please enter an On-Site Contact Name.','chrOSPhone','#q','0','Please enter an On-Site Phone number.','chrOSEmail','#q','0','Please enter an On-Site Email address.','dtArrival','#q','0','Please enter an Arrival Time','dtDeparture','#q','0','Please enter an End/Departure Time');return document.MM_returnValue" value="Update Cart">
                  <input name="idExpedite" type="hidden" value="<%=rsCart("idExpedite")%>">
<%
	if rsCart("idBilled") = false then
		idBilled = 0
	else
		idBilled = 1
	end if
%>
                  <input name="idBilled" type="hidden" value="<%=idBilled%>">
                  <input name="idLoaner" type="hidden" value="<%=rsCart("idLoaner")%>">
                  <input name="idStatus" type="hidden" value="<%=rsCart("idStatus")%>">
