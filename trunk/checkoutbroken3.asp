...
<form name="form1" method="post" action="checkoutbrokenfinal.asp">
                  ...
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="3">
                      ...
                      <tr> 
                        <td bgcolor="#f5f5f5"><font size="1" face="Arial, Helvetica, sans-serif">Please 
                          fill out the information below so that we can generate a report for broken assets.</font></td>
                      </tr>
                    </table></td>
                </tr>
                <tr> 
...
%>
                      ...
                      <tr> 
                        <td><font size="1" face="Arial, Helvetica, sans-serif">Problem 
                          with Asset<br>
                          <textarea name="txtProblem" cols="45" rows="10" wrap="VIRTUAL" id="txtProblem">Please indicate what the problem is.</textarea>
                          </font></td>
                      </tr>
                    </table></td>
                </tr>
