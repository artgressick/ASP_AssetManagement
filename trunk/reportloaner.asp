...
<%
	...
	if flag = 0 then
		...
		if session("idAccess") < "O" then
			sql = "execute ListCartsWithLoanerAgreement " & idCustomer
		else
			sql = "execute ListCartsWithLoanerAgreementbyAccess " & idCustomer & "," & session("idUser")
		end if
...
<form name="form1" method="post" action="reportloaner.asp">
            ...
            <td width="100%"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr> 
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="3">
                      <tr> 
                        <td><font size="3" face="Arial, Helvetica, sans-serif"><strong>Loaner Agreement Orders</strong></font></td>
                      </tr>
                    </table></td>
                </tr>
                <tr> 
