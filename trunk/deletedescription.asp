...
<form name="form1" method="post" action="removedescription.asp"> 
          ...
          <tr>
            ...
            <td width="610"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr> 
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="3">
                      <tr> 
                        <td align="center"><font color="#FF0000" size="2" face="Arial, Helvetica, sans-serif"><strong>You are about to remove the following Descriptions. This cannot be undone.</strong></font></td>
                      </tr>
                      <tr> 
                        <td align="center"><font color="#FF0000" size="2" face="Arial, Helvetica, sans-serif"><%=rsDescription("chrItemNo")%></font></td>
                      </tr>
                      <tr> 
                        <td align="center"><font color="#FF0000" size="2" face="Arial, Helvetica, sans-serif"><%=trim(rsDescription("chrItem")) & " - " & trim(rsDescription("chrProcessor"))%></font></td>
                      </tr>
                      <tr> 
                        <td align="center"><font color="#FF0000" size="2" face="Arial, Helvetica, sans-serif"><%=trim(rsDescription("chrMemory")) & " - " & trim(rsDescription("chrODrive"))%></font></td>
                      </tr>
                    </table></td>
                </tr>
                <tr> 
                ...
                <tr> 
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="3">
                      <tr> 
                        <td align="center"><input type="submit" name="submit1" id="submit1" value="Cancel Removal">&nbsp;&nbsp; <input name="submit2" type="submit" id="submit2" value="Remove Description"> 
