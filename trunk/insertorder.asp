...
<%
	...
	if datediff("d",dtArrival,dtDeparture) > 0 then
		...
		'figure the Pull date to minus 1 day from the ship date
			...
			"Thank you for placing your order in the techIT Solutions Asset Management System." & VbCrLf & VbCrLf &_
			"Your First Cart: " & replace(request("chrCart"),"'","''") & " has automatically been created and if you haven't already done so, you may now add assets to this cart.  Once you have added all required assets, please complete the check out procedure.  Completing this process will generate an email to your Pool Manager requesting approval of your Cart." & VbCrLf & VbCrLf &_
			...
			if cint(request("idSupport")) = 1 then
				...
				Mailer.AddRecipient "Michelle Rheinfrank", "michelle@techitsolutions.com"
