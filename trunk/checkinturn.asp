...
<%
	...
	if session("idLoadInW") = "" then
		Response.Redirect "loadcheckinturn.asp"
	end if
...
<form name="form1" method="post" action="checkinturnasset.asp">
            ...
            <td width="610"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="3">
                      <tr>
                        <td><font size="3" face="Arial, Helvetica, sans-serif"><strong>Check In &amp; Turn </strong></font></td>
                      ...
                      <tr bgcolor="#f5f5f5">
                        <td colspan="2"><font size="1" face="Arial, Helvetica, sans-serif">To check in &amp; turn an asset please scan the UPC code with the scanner. The next screen will give you a status of the scan. Please make sure to scan an asset and then watch the next screen.</font></td>
                      </tr>
                    </table></td>
                </tr>
                <tr>
						  ...
						  <table width="100%" border="0" cellspacing="0" cellpadding="5">
                            ...
                            <tr>
                              <td align="center"><font size="1" face="Arial, Helvetica, sans-serif">
                                <input name="Submit" type="submit" onClick="YY_checkform('form1','chrAssNum','#q','0','Please scan the Asset.');return document.MM_returnValue" value="Check In / Turn">
                                </font></td>
                            </tr>
                          </table></td>
