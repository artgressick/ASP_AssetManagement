...
<form name="form1" method="post" action="reportwhatsavailable.asp">
            ...
            <td width="100%"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr> 
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="3">
                      <tr> 
                        <td><font size="3" face="Arial, Helvetica, sans-serif"><strong>What's Available Report</strong></font></td>
                      </tr>
                    </table>
                  </td>
                </tr>
                  ...
                  <td height="1" bgcolor="#c0c0c0">
			        <table width="100%" border="0" cellspacing="1" cellpadding="3">
                      <tr> 
						...
						We recommend adding 7 days to the date on which you will ship back the assets.</font></p>
                        </font></td>
                      </tr>
                    </table>
                  </td>
                        ...
                        <td bgcolor="#c0c0c0">
                          <table width="100%" border="0" cellspacing="0" cellpadding="3">
                            <tr bgcolor="#f5f5f5"> 
                              ...
                              <td><font size="1" face="Arial, Helvetica, sans-serif"><input name="dtPull" type="text" id="dtPull" size="10" maxlength="10" value="<%=request("dtPull")%>">&nbsp;&nbsp;<a href="#" onClick="YY_Calendar('dtPull',250,275,'de','#000000','#f5f5f5','YY_calendar1')"><img src="images/calendar.gif" width="34" height="21" border="0"></a></font></td>
                              <td align="right"><font size="1" face="Arial, Helvetica, sans-serif">End Date</font></td>
                              <td><font size="1" face="Arial, Helvetica, sans-serif"><input name="dtTurn" type="text" id="dtTurn" size="10" maxlength="10" value="<%=request("dtTurn")%>">&nbsp;&nbsp;<a href="#" onClick="YY_Calendar('dtTurn',435,275,'de','#000000','#f5f5f5','YY_calendar1')"><img src="images/calendar.gif" width="34" height="21" border="0"></a></font></td>
...
%>
                <tr> 
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td height="20" bgcolor="#c0c0c0" colspan="4">
                          <table width="100%" border="0" cellspacing="0" cellpadding="5">
                            <tr>
                              <td align="left"><a HREF="javascript:newWindow('excel/excelwhatsavailable.asp?idCustomer=<%=request("idCustomer")%>&idCategory=<%=request("idCategory")%>&dtPull=<%=request("dtPull")%>&dtTurn=<%=request("dtTurn")%>')"><img SRC="images/exporttoexcel.gif" border="0" WIDTH="120" HEIGHT="19"></a></td>
                            </tr>
                          </table>
                        </td>
                      </tr>
