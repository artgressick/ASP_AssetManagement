...
<%
	...
	if flag = 0 then
		...
		if session("idAccess") < "O" then
			sql = "execute ListFutureActivity " & idCategory & ",'" & request("dtPull") & "','" & request("dtTurn") & "'"
		else
			sql = "execute ListFutureActivitybyAccess " & idCategory & "," & session("idUser") & ",'" & request("dtPull") & "','" & request("dtTurn") & "'"
		end if
...
<form name="form1" method="post" action="reportfutureactivity.asp">
            ...
            <td width="100%"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr> 
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="3">
                      <tr> 
                        <td><font size="3" face="Arial, Helvetica, sans-serif"><strong>Future Activity Report</strong></font></td>
                      </tr>
                    </table></td>
                </tr>
                <tr> 
                      ...
                      <tr>
                        <td bgcolor="#c0c0c0">
                          <table width="100%" border="0" cellspacing="0" cellpadding="3">
                            <tr bgcolor="#f5f5f5"> 
                              <td align="left"><font size="1" face="Arial, Helvetica, sans-serif">This report provides detailed information regarding the 
                                specific location of a piece of equipment over a given period of time.  Please 
                                enter the beginning and end date range to determine the location of equipment 
                                for that specific period of time.  After you have entered the date range, please 
                                choose the category of equipment for which you are interested and click 
                                the Find button.</font></td>
                            </tr>
                          </table>
                         </td>
                      </tr>
                        ...
                        <td bgcolor="#c0c0c0">
                          <table width="100%" border="0" cellspacing="0" cellpadding="3">
                            <tr bgcolor="#f5f5f5"> 
                              ...
                              <td align="right"><font size="1" face="Arial, Helvetica, sans-serif">Category</font></td>
                      ...
                      <tr>
                        <td height="20" bgcolor="#c0c0c0" colspan="6">
                          <table width="100%" border="0" cellspacing="0" cellpadding="5">
                            <tr>
                              <td align="left"><a HREF="javascript:newWindow('excel/excelfuture.asp?idCategory=<%=idCategory%>&dtPull=<%=request("dtPull")%>&dtTurn=<%=request("dtTurn")%>')"><img SRC="images/exporttoexcel.gif" border="0" WIDTH="120" HEIGHT="19"></a></td>
                            </tr>
                          </table>
                        </td>
                      </tr>
                      <tr> 
                        <td height="20" bgcolor="#6699cc"><font color="#FFFFFF" size="1" face="Arial, Helvetica, sans-serif">&nbsp;Asset #</font></td>
                        ...
                        <td height="20" bgcolor="#6699cc"><font color="#FFFFFF" size="1" face="Arial, Helvetica, sans-serif">&nbsp;Pull Date</font></td>
                        <td height="20" bgcolor="#6699cc"><font color="#FFFFFF" size="1" face="Arial, Helvetica, sans-serif">&nbsp;Turn Date</font></td>
                      </tr>
                      <tr bgcolor="#c0c0c0"> 
...
%>
                      <tr> 
                        <td height="20" align="center" colspan="5"><font color="#FFFFFF" size="1" face="Arial, Helvetica, sans-serif"></font></td>
                      </tr>
                      <tr bgcolor="#c0c0c0"> 
                        <td height="1" colspan="5"><img src="images/c0c0c0dot.gif" width="1" height="1"></td>
                      </tr>
...
%>
                        ...
                        <td height="20"><font size="1" face="Arial, Helvetica, sans-serif">&nbsp;<%=formatdatetime(rsInventory("dtPull"),2)%></font></td>
                        <td height="20"><font size="1" face="Arial, Helvetica, sans-serif">&nbsp;<%=formatdatetime(rsInventory("dtTurn"),2)%></font></td>
                      </tr>
                      <tr bgcolor="#c0c0c0"> 
                        <td height="1" colspan="5"><img src="images/c0c0c0dot.gif" width="1" height="1"></td>
                      </tr>
