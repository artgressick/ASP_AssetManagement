...
<body bgcolor="#FFFFFF" text="#000000" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onLoad="document.form1.chrCart.focus()">
                ...
                <tr> 
                  <td bgcolor="#5b5b5b">
					<table width="100%" border="0" cellspacing="1" cellpadding="3">
                      <tr> 
                        <td bgcolor="#f5f5f5"><font size="2" face="Arial, Helvetica, sans-serif"><strong>Cart Information</strong><br>
...
%>
                      <tr> 
                        <td width="50%"><font color="#FF0000" size="2">*</font><font color="#000000" size="1" face="Arial, Helvetica, sans-serif">Arrival Date (example: 01/01/2003)</font><br>
                          <font size="1" face="Arial, Helvetica, sans-serif"><input name="dtArrival" type="text" id="dtArrival" size="12" maxlength="10" tabindex="7" value="<%=trim(rsOrder("dtArrival"))%>">&nbsp;&nbsp;<a href="#" onClick="YY_Calendar('dtArrival',335,330,'de','#000000','#f5f5f5','YY_calendar1')"><img src="images/calendar.gif" width="34" height="21" border="0"></a></font></td>
                        <td width="50%"><font color="#FF0000" size="2">*</font><font color="#000000" size="1" face="Arial, Helvetica, sans-serif">End / Departure Date (example: 01/01/2003)</font><br>
                          <font size="1" face="Arial, Helvetica, sans-serif"><input name="dtDeparture" type="text" id="dtDeparture" size="12" maxlength="10" tabindex="9" value="<%=trim(rsOrder("dtDeparture"))%>">&nbsp;&nbsp;<a href="#" onClick="YY_Calendar('dtDeparture',387,330,'de','#000000','#f5f5f5','YY_calendar1')"><img src="images/calendar.gif" width="34" height="21" border="0"></a></font></td>
                      </tr>
                      <tr> 
                        <td width="50%"><font size="1" face="Arial, Helvetica, sans-serif">Arrival Time (if applicable) (example: 12:01 PM)</font><br>
                          <font size="1" face="Arial, Helvetica, sans-serif"><input name="dtArrivalTime" type="text" id="dtArrivalTime" size="10" maxlength="8" tabindex="8"></font></td>
                        <td width="50%"><font size="1" face="Arial, Helvetica, sans-serif">End / Departure Time (if applicable) (example: 9:00 AM)</font><br>
                          <font size="1" face="Arial, Helvetica, sans-serif"><input name="dtDepartureTime" type="text" id="dtDepartureTime" size="10" maxlength="8" tabindex="10"></font></td>
                      </tr>
<%
...
%>
                      <tr> 
                        <td width="100%" colspan="2"><font size="1" face="Arial, Helvetica, sans-serif">Since you will be creating your first cart, does this cart need to have <font color="#0000ff">assets that ship directly from another show</font>?</font><br>
                          <font size="1" face="Arial, Helvetica, sans-serif"><select name="idShow2Show" size="1" id="idShow2Show" tabindex="11">
...
%>
                      ...
                      <tr> 
                        <td width="50%"><font size="1" face="Arial, Helvetica, sans-serif">Arrival Time (if applicable) (example: 12:01 PM)</font><br>
                          <font size="1" face="Arial, Helvetica, sans-serif"><input name="dtArrivalTime" type="text" id="dtArrivalTime" size="10" maxlength="8" tabindex="8"><input name="idShow2Show" type="hidden" id="idShow2Show" value="0"></font></td>
                        <td width="50%"><font size="1" face="Arial, Helvetica, sans-serif">End / Departure Time (if applicable) (example: 9:00 AM)</font><br>
                          <font size="2" face="Arial, Helvetica, sans-serif" color="#0000ff"><strong>Undefined</strong></font></td>
                      </tr>
<%
                        ...
                        <td width="100%" bgcolor="#f5f5f5"> <table width="100%" border="0" cellspacing="0" cellpadding="3">
                            <tr> 
                              <td><font color="#FF0000" size="2">*</font><font size="1" face="Arial, Helvetica, sans-serif" color="#000000">To (Booth / Receiving Party)<br>
                                <input name="chrAddress" type="text" id="chrAddress" size="55" maxlength="75" tabindex="<%=tabindex+2%>" value="<%=trim(rsOrder("chrAddress"))%>"></font></td>
                            </tr>
                            <tr> 
                              <td><font color="#FF0000" size="2">*</font><font size="1" face="Arial, Helvetica, sans-serif" color="#000000">Address (Company / Hotel / Venue)<br>
                                <input name="chrAddress2" type="text" id="chrAddress2" size="55" maxlength="75" tabindex="<%=tabindex+3%>" value="<%=trim(rsOrder("chrAddress2"))%>"></font></td>
                            </tr>
                            <tr> 
                              <td><font size="1" face="Arial, Helvetica, sans-serif" color="#000000">Address (PO Box / Street Address)<br>
                                <input name="chrAddress3" type="text" id="chrAddress3" size="55" maxlength="75" tabindex="<%=tabindex+4%>" value="<%=trim(rsOrder("chrAddress3"))%>"></font></td>
                            </tr>
                            <tr> 
                              <td><font size="1" face="Arial, Helvetica, sans-serif">Address (c/o or additional information)<br>
                                <input name="chrAddress4" type="text" id="chrAddress4" size="55" maxlength="75" tabindex="<%=tabindex+5%>" value="<%=trim(rsOrder("chrAddress4"))%>"></font></td>
                            </tr>
                            <tr> 
                              <td><font color="#FF0000" size="2">*</font><font size="1" face="Arial, Helvetica, sans-serif" color="#000000">City<br>
                                <input name="chrCity" type="text" id="chrCity" size="45" maxlength="75" tabindex="<%=tabindex+6%>" value="<%=trim(rsOrder("chrCity"))%>"></font></td>
                            </tr>
                            <tr> 
                              <td><font color="#FF0000" size="2">*</font><font size="1" face="Arial, Helvetica, sans-serif" color="#000000">State / Province<br>
                                <input name="chrState" type="text" id="chrState" size="22" maxlength="20" tabindex="<%=tabindex+7%>" value="<%=trim(rsOrder("chrState"))%>"></font></td>
                            </tr>
                            <tr> 
                              <td><font color="#FF0000" size="2">*</font><font size="1" face="Arial, Helvetica, sans-serif" color="#000000">Zip Code<br>
                                <input name="chrZip" type="text" id="chrZip" size="20" maxlength="14" tabindex="<%=tabindex+8%>" value="<%=trim(rsOrder("chrZip"))%>"></font></td>
                            </tr>
                            <tr> 
                              <td><font color="#FF0000" size="2">*</font><font size="1" face="Arial, Helvetica, sans-serif" color="#000000">Country<br>
                                <input name="chrCountry" type="text" id="chrCountry" size="35" maxlength="35" tabindex="<%=tabindex+9%>" value="<%=trim(rsOrder("chrCountry"))%>"></font></td>
                            </tr>
                            <tr> 
                  ...
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="3">
					  ...
					  <tr> 
                        <td width="50%"><font color="#0000ff" size="1" face="Arial, Helvetica, sans-serif">Apple Requestor Name</font><font size="1" face="Arial, Helvetica, sans-serif"><br>
                          <input name="chrARName" type="text" id="chrARName" size="40" maxlength="50" tabindex="<%=tabindex+2%>" value="<%=trim(rsOrder("chrARName"))%>"></font></td>
                        <td width="50%"><font color="#0000ff" size="1" face="Arial, Helvetica, sans-serif">Apple Requestor Email</font><font size="1" face="Arial, Helvetica, sans-serif"><br>
                          <input name="chrAREmail" type="text" id="chrAREmail" size="40" maxlength="100" tabindex="<%=tabindex+6%>" value="<%=trim(rsOrder("chrAREmail"))%>"></font></td>
                      </tr>
                      <tr> 
                        <td width="50%"><font color="#FF0000" size="2">*</font><font color="#000000" size="1" face="Arial, Helvetica, sans-serif">On-Site Contact Name</font><font size="1" face="Arial, Helvetica, sans-serif"><br>
                          <input name="chrOSPerson" type="text" id="chrOSPerson" size="40" maxlength="50" tabindex="<%=tabindex+3%>" value="<%=trim(rsOrder("chrOSPerson"))%>"></font></td>
                        <td width="50%"><font color="#FF0000" size="2">*</font><font color="#000000" size="1" face="Arial, Helvetica, sans-serif">On-Site Contact Phone (example: 408 555-1212)</font><font size="1" face="Arial, Helvetica, sans-serif"><br>
                          <input name="chrOSPhone" type="text" id="chrOSPhone" size="20" maxlength="14" tabindex="<%=tabindex+7%>" value="<%=trim(rsOrder("chrOSPhone"))%>"></font></td>
                      </tr>
                      <tr> 
                        <td width="50%"><font color="#FF0000" size="2">*</font><font color="#000000" size="1" face="Arial, Helvetica, sans-serif">On-Site Contact Email</font><font size="1" face="Arial, Helvetica, sans-serif"><br>
                          <input name="chrOSEmail" type="text" id="chrOSEmail" size="40" maxlength="100" tabindex="<%=tabindex+4%>" value="<%=trim(rsOrder("chrOSEmail"))%>"></font></td>
                        <td width="50%"><font size="1" face="Arial, Helvetica, sans-serif">On-Site Contact Fax Number (example: 408 555-1212)<br>
                          <input name="chrOSFax" type="text" id="chrOSFax" size="20" maxlength="14" tabindex="<%=tabindex+8%>" value="<%=trim(rsOrder("chrOSFax"))%>"></font></td>
                      </tr>
					  <tr> 
...
%>
					  <tr> 
						<td><font size="1" face="Arial, Helvetica, sans-serif">What will the equipment be used for? &nbsp;How will it be displayed? &nbsp;What properties are being used? &nbsp;Who from Apple will<br> 
                          ...
                          <textarea name="txtNotes" cols="60" rows="5" wrap="VIRTUAL" id="txtNotes" tabindex="<%=tabindex+1%>"><%=trim(rsOrder("txtNotes"))%></textarea>
                          </font> </td>
                      </tr>
                    </table></td>
                </tr>
                        ...
                        <td width="100%" bgcolor="#f5f5f5"> <table width="100%" border="0" cellspacing="0" cellpadding="3">
                            <tr> 
                              <td width="50%"><font color="#FF0000" size="2">*</font><font size="1" face="Arial, Helvetica, sans-serif" color="#000000">Carrier Name<br>
                                <input name="chrCarrier" type="text" id="chrCarrier" size="30" maxlength="30" tabindex="<%=tabindex+2%>" value="<%=trim(rsOrder("chrCarrier"))%>"></font></td>
                              <td width="50%"><font color="#FF0000" size="2">*</font><font size="1" face="Arial, Helvetica, sans-serif" color="#000000">Carrier Account Number<br>
                                <input name="chrAccount" type="text" id="chrAccount" size="30" maxlength="25" tabindex="<%=tabindex+3%>" value="<%=trim(rsOrder("chrAccount"))%>"></font></td>
                            </tr>
                            <tr> 
...
%>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="3">
					  <tr> 
						<td><font size="1" face="Arial, Helvetica, sans-serif">Please put any special needs, setup notes or anything that you need the warehouse to know in the space below. You can add more notes to this order at any time.<br>
                          <textarea name="txtShippingNotes" cols="60" rows="5" wrap="VIRTUAL" id="txtShippingNotes" tabindex="<%=tabindex+1%>"><%=trim(rsOrder("txtNotes"))%></textarea>
                          </font></td>
                      </tr>
                    </table></td>
                </tr>
                ...
                <tr> 
				  ...
				  <input name="idType" type="hidden" value="<%=rsOrder("idType")%>">
				  <input name="idOrder" type="hidden" value="<%=request("idOrder")%>"></td>
                </tr>
                <tr> 
                  <td height="25"><img src="images/ffffffdot.gif" width="1" height="1"></td>
                </tr>
