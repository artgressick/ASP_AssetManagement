...
<%
	...
	if request("dtPull") = "" or request("dtTurn") = "" then
		...
		sql = "execute ListUsageReport " & request("idCustomer") & "," & request("idCategory") & ",'" & request("dtPull") & "','" & request("dtTurn") & "'"
		set rsInventory = dbConnection.Execute(sql)
		
		'get the stats ready
		totaldays = datediff("d",request("dtPull"),request("dtTurn"))
	end if
...
<form name="form1" method="post" action="reportusage.asp">
            ...
            <td width="100%"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr> 
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="3">
                      <tr> 
                        <td><font size="3" face="Arial, Helvetica, sans-serif"><strong>Customer Usage Report</strong></font></td>
                      </tr>
                    </table>
                  </td>
                </tr>
                        ...
                        <td bgcolor="#c0c0c0">
                          <table width="100%" border="0" cellspacing="0" cellpadding="3">
                            <tr bgcolor="#f5f5f5"> 
                              ...
                              <td><font size="1" face="Arial, Helvetica, sans-serif"><input name="dtTurn" type="text" id="dtTurn" size="10" maxlength="10" value="<%=request("dtTurn")%>">&nbsp;&nbsp;<a href="#" onClick="YY_Calendar('dtTurn',435,160,'de','#000000','#f5f5f5','YY_calendar1')"><img src="images/calendar.gif" width="34" height="21" border="0"></a></font></td>
						      <td><font size="1" face="Arial, Helvetica, sans-serif"><select name="idCustomer" size="1" id="idCustomer">
                                <option value="0" <%if cint(request("idCustomer")) = 0 then%>selected<%end if%>>Please choose</option>
<%
...
%>
                              ...
                              <td><font size="1" face="Arial, Helvetica, sans-serif"><input name="Submit" type="submit" onClick="YY_checkform('form1','idCustomer','#q','1','Please choose a Customer.','dtPull','#q','0','Please enter a Begin Date.','dtTurn','#q','0','Please enter an End Date.');return document.MM_returnValue" value="Find"></font></td>
                            </tr>
                          </table>
                        </td>
                      </tr>
                  ...
                  <td>
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td height="20" bgcolor="#c0c0c0" colspan="6">
                          <table width="100%" border="0" cellspacing="0" cellpadding="5">
                            <tr>
                              <td align="left"><a HREF="javascript:newWindow('excel/excelusage.asp?idCustomer=<%=request("idCustomer")%>&idCategory=<%=request("idCategory")%>&dtPull=<%=request("dtPull")%>&dtTurn=<%=request("dtTurn")%>')"><img SRC="images/exporttoexcel.gif" border="0" WIDTH="120" HEIGHT="19"></a></td>
                            </tr>
                          </table>
                        </td>
                      </tr>
                      <tr bgcolor="#6699cc"> 
                        ...
                        <td height="20"><font color="#FFFFFF" size="1" face="Arial, Helvetica, sans-serif">&nbsp;% Usage</font></td>
                      </tr>
<%
...
%>
                      <tr bgcolor="<%=bgcolor%>"> 
                        <td height="20"><font size="1" face="Arial, Helvetica, sans-serif">&nbsp;<%=rsInventory("chrAssNum")%></font></td>
...
<%
		...
		'get the stats for this items
		if len(rsInventory("intDays")) > 0 then
			singlestats = round((rsInventory("intDays")/totaldays)*100,0)
		else
			singlestats = 0
		end if
		'keep running total of stats
		finalstats = finalstats + singlestats
%>
                        <td height="20"><font size="1" face="Arial, Helvetica, sans-serif">&nbsp;<%=singlestats%>%</font></td>
                      </tr>
                      <tr bgcolor="#c0c0c0"> 
...
%>
                      <tr bgcolor="#6699cc"> 
                        <td height="20" colspan="3" align="right"><font color="#FFFFFF" size="1" face="Arial, Helvetica, sans-serif">Total Usage for Category&nbsp;</font></td>
                        <td height="20"><font color="#FFFFFF" size="1" face="Arial, Helvetica, sans-serif">&nbsp;<%=round((finalstats/counter),0)%>%</font></td>
                      </tr>
<%
	end if
	rsInventory.Close
