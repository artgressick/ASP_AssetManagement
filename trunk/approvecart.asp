...
<%
	...
	sql = "execute ListInvoiceAssetsSummarybyCart " & request("idCart")
                ...
                <tr> 
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="3">
                      <tr> 
                        ...
                        <td align="right" valign="bottom"><font size="1" face="Arial, Helvetica, sans-serif"><a href="approvecartdetail.asp?idCart=<%=request("idCart")%>">Detail View</a> | <a href="accountteam.asp">Need Help</a>?</font></td>
                      </tr>
                    </table>
                  </td>
                </tr>
...
%>
                            <tr align="center"> 
                              <td height="20" colspan="2" bgcolor="#ffffff"><font size="1" face="Arial, Helvetica, sans-serif">No Assets have been requested at this time.</font></td>
                            </tr>
<%
	else
...
%>
                              <td height="20" align="center"><font size="1" face="Arial, Helvetica, sans-serif"><%=rsAssets("intCount")%></font></td>
                            </tr>
<%
			'totals
			intCount = intCount + rsAssets("intCount")
			rsAssets.MoveNext
		loop
%>
                            <tr bgcolor="#c0c0c0">
                              <td height="20" align="right"><font size="1" face="Arial, Helvetica, sans-serif">Total Assets Requested&nbsp;</font></td>
                              <td height="20" align="center"><font size="1" face="Arial, Helvetica, sans-serif">&nbsp;<%=intCount%>&nbsp;</font></td>
                            </tr>
<%
	end if
%>
