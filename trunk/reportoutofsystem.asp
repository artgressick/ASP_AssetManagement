...
<%
	...
	if flag = 0 then
		...
		if session("idAccess") < "O" then
			sql = "execute ListInventoryOutofSystem " & idCustomer
		else
			sql = "execute ListInventoryOutofSystembyAccess " & idCustomer & "," & session("idUser")
		end if
...
<form name="form1" method="post" action="reportoutofsystem.asp">
            ...
            <td width="100%"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr> 
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="3">
                      <tr> 
                        <td><font size="3" face="Arial, Helvetica, sans-serif"><strong>Assets Out of System Report</strong></font></td>
                      </tr>
                    </table></td>
                </tr>
                <tr> 
                      ...
                      <tr>
                        <td height="20" bgcolor="#c0c0c0" colspan="7">
                          <table width="100%" border="0" cellspacing="0" cellpadding="5">
                            <tr>
                              <td align="left"><a HREF="javascript:newWindow('excel/exceloutofsys.asp?idCustomer=<%=idCustomer%>')"><img SRC="images/exporttoexcel.gif" border="0" WIDTH="120" HEIGHT="19"></a></td>
                            </tr>
                          </table>
                        </td>
                      </tr>
...
%>
                        <td height="20"><font size="1" face="Arial, Helvetica, sans-serif">&nbsp;<%=formatdatetime(rsInventory("dtOut"),2)%></font></td>
                      </tr>
                      <tr bgcolor="#c0c0c0"> 
