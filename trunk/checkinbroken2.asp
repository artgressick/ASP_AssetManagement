...
<%
	...
	if rsInventory.EOF then
		...
		if rsInventory("idStatus") <> 8 then
			errorflag = 1 'AEG - this asset needs to be checked back in first
			errormessage = "This asset's status is not broken. Please make sure that you have not already check this asset back in."
		else
			errorflag = 0 'AEG - ok
			set rsProblems = server.CreateObject("adodb.recordset")
			sql = "execute FindOpenBrokenTicketbyInventory " & rsInventory("idInventory")
...
<form name="form1" method="post" action="checkinbrokenfinal.asp">
                ...
                <tr> 
                  <td>
					<table width="100%" border="0" cellspacing="0" cellpadding="3">
                      <tr> 
                        <td><font size="3" face="Arial, Helvetica, sans-serif"><strong>Check In Broken</strong></font></td>
                      </tr>
                      <tr> 
                        <td bgcolor="#f5f5f5"><font size="1" face="Arial, Helvetica, sans-serif">Listed below are the open tickets for repair. Please check the system before contining.
                        We recommend that you turn the asset first before returning it to the system.</font></td>
                      </tr>
                    </table>
                  </td>
                </tr>
                ...
                <tr> 
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="3">
                      <tr>
                        ...
                        <font size="2"><b><%=rsProblems("chrWarehouse")%></b></font></font></td>
                      </tr>
<%
...
%>
                      ...
                      <tr> 
                        ...
                        <font size="2"><b><%=trim(rsProblems("txtProblem"))%></b></font></font></td>
                      </tr>
                    </table></td>
                </tr>
                <tr>
                  ...
                  <td>
					<table width="100%" border="0" cellspacing="0" cellpadding="3">
                      <tr align="center"> 
                        ...
                        <input name="idBroken" type="hidden" value="<%=rsProblems("idBroken")%>"></td>
