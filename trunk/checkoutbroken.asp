...
<form name="form1" method="post" action="checkoutbroken2.asp">
            ...
            <td width="610"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr> 
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="3">
                      <tr> 
                        <td><font size="3" face="Arial, Helvetica, sans-serif"><strong>Check 
                          Out Broken</strong></font></td>
                      </tr>
                      <tr> 
                        <td bgcolor="#f5f5f5"><font size="1" face="Arial, Helvetica, sans-serif">Please 
                          scan or type the asset number of the asset you wish 
                          to check out as broken. Then click Retreive Asset.</font></td>
                      </tr>
                    </table></td>
                </tr>
                <tr> 
