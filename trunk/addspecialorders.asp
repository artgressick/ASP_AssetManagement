...
<form name="form1" method="post" action="insertspecialorders.asp">
            ...
            <td width="610"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr> 
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="3">
                      <tr> 
                        <td><strong><font size="3" face="Arial, Helvetica, sans-serif">Transfer Assets from the <%=trim(rsCustomer("chrCustomer"))%> Pool to Internal Use or Out of System</font></strong></td>
                      </tr>
                      <tr bgcolor="#f5f5f5"> 
                        <td><font size="1" face="Arial, Helvetica, sans-serif">Please enter the information requested below to add a new order. &nbsp;All fields with <font color="#FF0000" size="2">*</font> are required, and all information must be entered as per the examples given.</font></td>
                      </tr>
                    </table></td>
                </tr>
                <tr> 
                ...
                <tr> 
                  <td bgcolor="#5b5b5b"><table width="100%" border="0" cellspacing="1" cellpadding="3">
                      <tr> 
                        <td bgcolor="#f5f5f5"><font size="2" face="Arial, Helvetica, sans-serif"><strong>Order Type</strong>&nbsp;<font size="1">Please see Manager for definition of this type.</font></font></td>
                      </tr>
                    </table></td>
                </tr>
                <tr> 
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="3">
                      <tr> 
                        <td width="50%"><font color="#FF0000" size="2">*</font><font color="#000000" size="1" face="Arial, Helvetica, sans-serif">Order / Cart Type<br>
                          <select name="idType" size="1" id="idType" tabindex="12">
							<option value="0">Please Choose</option>
							<option value="2">Internal Use</option>
							<option value="3">Out of System</option>
						  </select></font></td>
                        <td width="50%"><font color="#000000" size="1" face="Arial, Helvetica, sans-serif">&nbsp;</font></td>
                      </tr>
                    </table></td>
                </tr>
                <tr> 
                  ...
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="3">
                      <tr> 
                        ...
                        <td width="50%"><font size="1" face="Arial, Helvetica, sans-serif">Your Manager<br>
                          <input name="chrManager" type="text" id="chrManager" size="30" maxlength="50" tabindex="4"></font></td>
                      </tr>
                      <tr> 
                        <td width="50%"><font color="#FF0000" size="2">*</font><font color="#000000" size="1" face="Arial, Helvetica, sans-serif">Your Division / Department <U>Name</U></font><font size="1" face="Arial, Helvetica, sans-serif"><br>
                          <input name="chrDDName" type="text" id="chrDDName" size="35" maxlength="50" tabindex="2"></font></td>
                        <td width="50%"><font size="1" face="Arial, Helvetica, sans-serif">Person to Receive Invoice (if differnet then on Account)<br>
                          <input name="chrIPerson" type="text" id="chrIPerson" size="30" maxlength="50" tabindex="5"></font></td>
                      </tr>
                      <tr> 
                        <td width="50%"><font color="#FF0000" size="2">*</font><font color="#000000" size="1" face="Arial, Helvetica, sans-serif">Your Division / Department <U>Number</U></font><font size="1" face="Arial, Helvetica, sans-serif"><br>
                          <input name="chrDDNumber" type="text" id="chrDDNumber" size="25" maxlength="25" tabindex="3"></font></td>
                        <td width="50%"><font size="1" face="Arial, Helvetica, sans-serif">Email of Person Receiving Invoice<br>
                          <input name="chrIEmail" type="text" id="chrIEmail" size="35" maxlength="100" tabindex="6"></font></td>
                      </tr>
                    </table></td>
                </tr>
                <tr> 
                  ...
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="3">
                      <tr> 
                        <td width="50%"><font color="#FF0000" size="2">*</font><font color="#000000" size="1" face="Arial, Helvetica, sans-serif">Arrival Date (exmaple: 01/01/2003)</font><font size="1" face="Arial, Helvetica, sans-serif"><br>
                          <input name="dtArrival" type="text" id="dtArrival" size="12" maxlength="10" tabindex="7">&nbsp;&nbsp;<a href="#" onClick="YY_Calendar('dtArrival',335,300,'de','#000000','#f5f5f5','YY_calendar1')"><img src="images/calendar.gif" width="34" height="21" border="0"></a></font></td>
                        <td width="50%"><font color="#000000" size="1" face="Arial, Helvetica, sans-serif">&nbsp;</font></td>
                      </tr>
                    </table></td>
                </tr>
                ...
                <tr> 
                  <td>
					<table width="100%" border="0" cellspacing="0" cellpadding="3">
                      <tr> 
                        <td><input type="radio" tabindex="11" name="ckAddress" value="0" <%if addressflag = 0 then%>checked<%end if%>></td>
...
%>
                <tr> 
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="3">
                      <tr> 
                        <td><input name="ckAddress" tabindex="13" type="radio" value="1" <%if addressflag = 1 then%>checked<%end if%>></td>
                        ...
                        <td width="100%" bgcolor="#f5f5f5"> <table width="100%" border="0" cellspacing="0" cellpadding="3">
                            <tr> 
                              <td><font color="#FF0000" size="2">*</font><font size="1" face="Arial, Helvetica, sans-serif" color="#000000">To (Booth / Receiving Party)<br>
                                <input name="chrAddress" type="text" id="chrAddress" size="55" maxlength="75" tabindex="15"></font></td>
                            </tr>
                            <tr> 
                              <td><font color="#FF0000" size="2">*</font><font size="1" face="Arial, Helvetica, sans-serif" color="#000000">Address (Company / Hotel / Venue)<br>
                                <input name="chrAddress2" type="text" id="chrAddress2" size="55" maxlength="75" tabindex="16"></font></td>
                            </tr>
                            <tr> 
                              <td><font color="#FF0000" size="2">*</font><font size="1" face="Arial, Helvetica, sans-serif" color="#000000">Address (PO Box / Street Address)<br>
                                <input name="chrAddress3" type="text" id="chrAddress3" size="55" maxlength="75" tabindex="17"></font></td>
                            </tr>
                            <tr> 
                              <td><font size="1" face="Arial, Helvetica, sans-serif">Address (c/o or additional information)<br>
                                <input name="chrAddress4" type="text" id="chrAddress4" size="55" maxlength="75" tabindex="18"></font></td>
                            </tr>
                            <tr> 
                              <td><font color="#FF0000" size="2">*</font><font size="1" face="Arial, Helvetica, sans-serif" color="#000000">City<br>
                                <input name="chrCity" type="text" id="chrCity" size="45" maxlength="75" tabindex="19"></font></td>
                            </tr>
                            <tr> 
                              <td><font color="#FF0000" size="2">*</font><font size="1" face="Arial, Helvetica, sans-serif" color="#000000">State / Providence<br>
                                <input name="chrState" type="text" id="chrState" size="22" maxlength="20" tabindex="20"></font></td>
                            </tr>
                            <tr> 
                              <td><font color="#FF0000" size="2">*</font><font size="1" face="Arial, Helvetica, sans-serif" color="#000000">Zip (example: 12345-1234)<br>
                                <input name="chrZip" type="text" id="chrZip" size="20" maxlength="14" tabindex="21"></font></td>
                            </tr>
                            <tr> 
                              <td><font color="#FF0000" size="2">*</font><font size="1" face="Arial, Helvetica, sans-serif" color="#000000">Country (United States, Japan, France)<br>
                                <input name="chrCountry" type="text" id="chrCountry" value="United States" size="35" maxlength="35" tabindex="22"></font></td>
                            </tr>
                            <tr> 
                              <td bgcolor="#c0c0c0"><font size="1" face="Arial, Helvetica, sans-serif"> 
                                <input name="idSaveAddress" type="checkbox" id="idSaveAddress" value="YES" tabindex="23">&nbsp;Save this address. &nbsp;&nbsp;&nbsp;Saved Name&nbsp; 
                                <input name="chrSavedAddressName" type="text" id="chrSavedAddressName" size="25" maxlength="50" tabindex="24">&nbsp;(example: My Office or The Javits.)</font></td>
                            </tr>
                          </table></td>
                      </tr>
                    </table></td>
                  ...
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="3">
                      <tr> 
                        <td width="50%"><font color="#FF0000" size="2">*</font><font color="#000000" size="1" face="Arial, Helvetica, sans-serif">Contact Name</font><font size="1" face="Arial, Helvetica, sans-serif"><br>
                          <input name="chrOSPerson" type="text" id="chrOSPerson" size="40" maxlength="50" tabindex="25"></font></td>
                      ...
                      <tr> 
                        <td width="50%"><font color="#FF0000" size="2">*</font><font color="#000000" size="1" face="Arial, Helvetica, sans-serif">Contact Email</font><font size="1" face="Arial, Helvetica, sans-serif"><br>
                          <input name="chrOSEmail" type="text" id="chrOSEmail" size="40" maxlength="100" tabindex="27"></font></td>
                        <td width="50%"><font size="1" face="Arial, Helvetica, sans-serif">Contact Fax Number (example: (408) 555-1212)<br>
                          <input name="chrOSFax" type="text" id="chrOSFax" size="20" maxlength="14" tabindex="28"></font></td>
                      </tr>
                    </table></td>
                </tr>
                <tr> 
...
%>
					  <tr> 
						<td><font size="1" face="Arial, Helvetica, sans-serif">What will the equipment be used for? &nbsp;How will it be displayed? &nbsp;What properties are being used? &nbsp;Who from Apple will<br> 
                          ...
                          <textarea name="txtNotes" cols="60" rows="5" wrap="VIRTUAL" id="txtNotes" tabindex="30"></textarea>
                          </font> </td>
                      </tr>
                    </table></td>
                </tr>
...
%>
                <tr> 
                  <td>
					<table width="100%" border="0" cellspacing="0" cellpadding="3">
                      <tr> 
                        <td><input type="radio" tabindex="31" name="ckCarrier" value="0" <%if carrierflag = 0 then%>checked<%end if%>></td>
                        <td width="100%"><font color="#0000FF" size="2" face="Arial, Helvetica, sans-serif"><STRONG>Your Saved Carriers:</STRONG></font></td>
                      </tr>
                      <tr> 
                        <td>&nbsp;</td>
                        <td width="100%" bgcolor="#f5f5f5"><font size="2" face="Arial, Helvetica, sans-serif"> 
                          <select name="idCarrier" size="1" id="idCarrier" tabindex="32">
<%
                        ...
                        <td width="100%" bgcolor="#f5f5f5"> <table width="100%" border="0" cellspacing="0" cellpadding="3">
                            <tr> 
                              <td width="50%"><font color="#FF0000" size="2">*</font><font size="1" face="Arial, Helvetica, sans-serif" color="#000000">Carrier Name<br>
                                <input name="chrCarrier" type="text" id="chrCarrier" size="30" maxlength="30" tabindex="33"></font></td>
                              <td width="50%"><font color="#FF0000" size="2">*</font><font size="1" face="Arial, Helvetica, sans-serif" color="#000000">Carrier Account Number<br>
                                <input name="chrAccount" type="text" id="chrAccount" size="30" maxlength="25" tabindex="34"></font></td>
                            </tr>
                            <tr> 
                              <td colspan="2" bgcolor="#c0c0c0"><font size="1" face="Arial, Helvetica, sans-serif"> 
                                <input name="idSaveCarrier" type="checkbox" id="idSaveCarrier" value="YES" tabindex="35">&nbsp;Save this Carrier.</font></td>
                            </tr>
                          </table></td>
                      </tr>
                    </table></td>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="3">
					  <tr> 
						<td><font size="1" face="Arial, Helvetica, sans-serif">Please put any special needs, setup notes or anything that you need the warehouse to know. You can add more notes to this order at anytime.<br>
                          <textarea name="txtShippingNotes" cols="60" rows="5" wrap="VIRTUAL" id="txtShippingNotes" tabindex="36"></textarea>
                          </font></td>
                      </tr>
                    </table></td>
                </tr>
...
%>
                <tr> 
                  <td><input name="Submit" type="submit" onClick="YY_checkform('form1','idType','#q','1','Please choose an Order/Cart Type.','idSaveAddress','chrSavedAddressName','2','Please enter a Name for the Saved Address.',<%=addressjavastring%><%=carrierjavastring%>'chrOrder','#q','0','Please enter the Order Name.','chrDDName','#q','0','Please enter the Division/Department Name.','chrDDNumber','#q','0','Please enter the Division/Department Number.','chrOSPerson','#q','0','Please enter an On-Site Contact Name.','chrOSPhone','#q','0','Please enter an On-Site Phone number.','chrOSEmail','#q','0','Please enter an On-Site Email address.');return document.MM_returnValue" value="Create Order">
				  <input name="idCustomer" type="hidden" value="<%=request("idCustomer")%>"></td>
                </tr>
                <tr> 
                  <td height="25"><img src="images/ffffffdot.gif" width="1" height="1"></td>
                </tr>
