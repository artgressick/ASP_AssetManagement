...
<%
	...
	select case rsAsset("idStatus")
		...
		case 2
			...
			'it has the correct id so we can check it back in and turn the asset
			'checkin the asset
			sql = "execute CheckInTurnAsset " & rsAsset("idCart") & "," & rsAsset("idInventory") & "," & session("idLoadInW") & "," & session("idUser")
	...
	if flag = 0 then
		Response.Redirect "checkinturn.asp?chrAssNum=" & request("chrAssNum") & "&idCart=" & rsAsset("idCart")
	end if
%>
			  ...
			  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="3">
                      <tr>
                        <td><font size="3" face="Arial, Helvetica, sans-serif"><strong>Check In &amp; Turn Error</strong></font></td>
                      ...
                      <tr bgcolor="#f5f5f5">
                        <td width="50%" bgcolor="#ffffff">
						  <table width="100%" border="0" cellspacing="0" cellpadding="5">
							...
							<tr>
                              <td align="center"><font size="2" face="Arial, Helvetica, sans-serif"><a href="checkinturn.asp">Click here to return to check in.</a></font></td>
                            </tr>
                          </table>
						</td>
                      </tr>
