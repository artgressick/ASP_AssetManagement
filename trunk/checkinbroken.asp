...
<form name="form1" method="post" action="checkinbroken2.asp">
                  ...
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="3">
                      ...
                      <tr> 
                        <td bgcolor="#f5f5f5"><font size="1" face="Arial, Helvetica, sans-serif">Please 
                          scan or type the asset number of the asset you wish to check in as broken. Then click Retreive Asset.</font></td>
                      </tr>
                    </table></td>
                </tr>
                <tr> 
