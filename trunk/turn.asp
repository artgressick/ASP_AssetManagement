...
<form name="form1" method="post" action="checkturn.asp">
            ...
            <td width="610"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="3">
                      <tr>
                        <td><font size="3" face="Arial, Helvetica, sans-serif"><strong>Turn Asset Process</strong></font></td>
                        <td align="right" valign="bottom"><font size="1" face="Arial, Helvetica, sans-serif"><a href="reportneedturning.asp">Assets Need Turning</a></font></td>
                      </tr>
                      <tr bgcolor="#f5f5f5">
                        <td colspan="2"><font size="1" face="Arial, Helvetica, sans-serif">To turn an asset please scan the UPC code or manually enter the asset number.<br>
                        The next screen will give you a status of the scan.</font></td>
                      </tr>
                    </table></td>
                </tr>
                <tr>
						  ...
						  <table width="100%" border="0" cellspacing="0" cellpadding="5">
                            ...
                            <tr>
                              <td align="center"><font size="1" face="Arial, Helvetica, sans-serif">
                                <input name="Submit" type="submit" onClick="YY_checkform('form1','chrAssNum','#q','0','Please scan the Asset.');return document.MM_returnValue" value="Turn Asset">
                                </font></td>
                            </tr>
                          </table></td>
