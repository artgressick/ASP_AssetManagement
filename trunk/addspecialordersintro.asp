...
<form name="form1" method="post" action="addspecialorders.asp">
            ...
            <td width="610"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr> 
                  <td>
                      ...
                      <tr> 
                        <td><strong><font size="3" face="Arial, Helvetica, sans-serif">Internal Use and Out of System Process</font></strong></td>
                      </tr>
                      <tr bgcolor="#f5f5f5"> 
                        <td><font size="1" face="Arial, Helvetica, sans-serif">From the drop-down list below, please select the Customer / Pool to affect with this order.  Then click the Continue button.</font></td>
                      </tr>
                    </table>
				  </td>
                </tr>
                      ...
                      <tr> 
                        <td><font size="1" face="Arial, Helvetica, sans-serif">Customer / Pool<br>
                          <select name="idCustomer" size="1" id="idCustomer">
                            <option value="0">Select Customer / Pool</option>
<%
...
%>
                ...
                <tr> 
                  <td><input name="Submit" type="submit" onClick="YY_checkform('form1','idCustomer','#q','1','Please choose a customer/pool.');return document.MM_returnValue" value="Continue"></td>
                </tr>
                <tr> 
                  <td height="15"><img src="images/ffffffdot.gif" width="1" height="1"></td>
                </tr>
