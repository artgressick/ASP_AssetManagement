...
<%
	...
	if session("idLoadOut") = "" then
		Response.Redirect "loadcheckout.asp"
	end if
...
<%
	...
	select case rsAsset("idStatus")
		case 1
			...
			'Find out if the Asset has been requested.
			set rsChecker = server.CreateObject("adodb.recordset")
			sql = "execute FindOrderedbyInvIDandCartID " & session("idLoadOut") & "," & rsAsset("idInventory")
			set rsChecker = dbConnection.Execute(sql)
			'if eof then it was not requested
			if rsChecker.eof then
				flag = 1
				message = "This Asset has not been requested. Please return the Asset to the shelf. If you plan on substituting this asset, please click on the Finished link and replace the asset."
			else
				'checkout the asset
				sql = "execute CheckOutAsset " & session("idLoadOut") & "," & rsAsset("idInventory") & "," & rsAsset("idWarehouse") & "," & session("idUser")
				dbConnection.execute(sql)
			end if
			'close the Checker Record Set
			rsChecker.close
		...
		case 3
			...
			flag = 1
			message = "This Asset has not been turned. Please make sure the software is up to date and all peripherals are in the box. Turn this asset and then return to Check out."
		case 4
			'This asset has been noted as out for Repair
			flag = 1
			message = "This Asset has been marked Out for Repair. Please ensure everything is working and then change the status to Ready."
		case 5
			'This asset is listed at Permanent Loan
			flag = 1
			message = "This Asset has been put on Permanent Loan please ensure it has been properly returned to the system before attempting to check it out."
		case 6
		...
		case 8
			...
			flag = 1
			message = "This Asset has  been marked Broken/Damaged. Please ensure it has been repaired before checking it out."
		case 9
	...
	if flag = 0 then
		Response.Redirect "checkout.asp?chrAssNum=" & request("chrAssNum")
	end if
%>
			  ...
			  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="3">
                      <tr>
                        <td><font size="3" face="Arial, Helvetica, sans-serif"><strong>Check Out Error</strong></font></td>
                        <td align="right" valign="bottom"><font size="1" face="Arial, Helvetica, sans-serif"><a href="pulllist.asp">Pull List</a> | <a href="finishedcheckout.asp">Finished</a>?</font></td>
                      </tr>
                      <tr bgcolor="#f5f5f5">
                        <td colspan="2"><font size="1" face="Arial, Helvetica, sans-serif">Please read the error indicated below and follow the recommended corrective actions.<br>
						    The Asset you entered has not been checked out at this time.</font></td>
                      </tr>
                    </table>
				  </td>
                </tr>
                      ...
                      <tr bgcolor="#f5f5f5">
                        <td width="50%" bgcolor="#ffffff">
						  <table width="100%" border="0" cellspacing="0" cellpadding="5">
							...
							<tr>
                              <td align="center"><font size="2" face="Arial, Helvetica, sans-serif"><a href="checkout.asp">Click here to return to check out.</a></font></td>
                            </tr>
                          </table>
						</td>
                      </tr>
