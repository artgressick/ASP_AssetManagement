...
<%
	...
	if request("dtPull") = "" or request("dtTurn") = "" then
		...
		if session("idAccess") < "O" then
			sql = "execute ListCartsExpedited " & idCustomer & ",'" & request("dtPull") & "','" & request("dtTurn") & "'"
		else
			sql = "execute ListCartsExpeditedbyAccess " & idCustomer & "," & session("idUser") & ",'" & request("dtPull") & "','" & request("dtTurn") & "'"
		end if
...
<form name="form1" method="post" action="reportexpedite.asp">
            ...
            <td width="100%"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr> 
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="3">
                      <tr> 
                        <td><font size="3" face="Arial, Helvetica, sans-serif"><strong>Expedited Carts Report</strong></font></td>
                      </tr>
                    </table></td>
                </tr>
                <tr>
                  ...
                  <td>
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td height="20" bgcolor="#c0c0c0" colspan="6">
                          <table width="100%" border="0" cellspacing="0" cellpadding="5">
                            <tr>
                              <td align="left"><a HREF="javascript:newWindow('excel/excelexpidite.asp?idCustomer=<%=idCustomer%>&dtPull=<%=request("dtPull")%>&dtTurn=<%=request("dtTurn")%>')"><img SRC="images/exporttoexcel.gif" border="0" WIDTH="120" HEIGHT="19"></a></td>
                            </tr>
                          </table>
                        </td>
                      </tr>
                      <tr bgcolor="#6699cc"> 
						...
						<td height="20"><font color="#ffffff" size="1" face="Arial, Helvetica, sans-serif">&nbsp;Expedite Level</font></td>
...
%>
                      <tr> 
                        <td height="20" colspan="6" align="center"><font size="1" face="Arial, Helvetica, sans-serif">Not Assets to Display.</font></td>
                      </tr>
                      <tr bgcolor="#c0c0c0"> 
...
%>
                      <tr bgcolor="#6699cc"> 
                        <td height="20" colspan="6" align="left"><font color="#ffffff" size="1" face="Arial, Helvetica, sans-serif">&nbsp;Total Carts: <%=counter%></font></td>
                      </tr>
                      <tr bgcolor="#c0c0c0"> 
                        <td height="1" colspan="6"><img src="images/c0c0c0dot.gif" width="1" height="1"></td>
                      </tr>
