...
<form name="form1" method="post" action="insertprofile.asp">
            ...
            <td width="610"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td><table width="100%" border="0" cellspacing="0" cellpadding="3">
                  <tr>
                    <td width="50%"><font size="3" face="Arial, Helvetica, sans-serif"><strong>Add Profile</strong></font></td>
                    <td width="50%">&nbsp;</td>
                  </tr>
                  <tr bgcolor="#f5f5f5">
                    <td colspan="2"><font size="1" face="Arial, Helvetica, sans-serif">Please fill in all information, then click the Add Profile button.<br>
					If you do not want to add at this time, please click the Back button in your browser.</font></td>
                    </tr>
                </table></td>
              </tr>
              <tr>
              ...
              <tr>
                <td><table width="100%" border="0" cellspacing="0" cellpadding="3">
                  ...
                  <tr>
                    <td><font size="1" face="Arial, Helvetica, sans-serif">Email Address<br>
                  ...
                  <tr>
                    <td bgcolor="#f5f5f5"><font size="1" face="Arial, Helvetica, sans-serif">Password<br>
                        <input name="chrPassword" type="password" id="chrPassword" size="12" maxlength="10">
                    </font></td>
                  </tr>
                  <tr>
                    <td><font size="1" face="Arial, Helvetica, sans-serif">Telephone (example: 408-555-1212)<br>
                        <input name="chrPhone" type="text" id="chrPhone" size="16" maxlength="14">
                    </font></td>
                  </tr>
                  <tr>
                    <td><font size="1" face="Arial, Helvetica, sans-serif">Fax (example: 408-555-1212)<br>
                        <input name="chrFax" type="text" id="chrFax" size="16" maxlength="14">
                    </font></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td height="27"><font size="1">
                      <input name="Submit" type="submit" onClick="YY_checkform('form1','chrFirst','#q','0','First Name must be filled out.','chrLast','#q','0','Last Name must be filled out.','chrEmail','#q','0','Email address must be filled out.','chrPhone','#q','0','Phone number must be filled out.','chrFax','#q','0','Fax number must be filled out.','chrPassword','#q','0','Password must be filled out.');return document.MM_returnValue" value="Add Profile">
                    </font></td>
                  </tr>
                </table></td>
              </tr>
