...
<body>
<form name="form1" method="post" action="inserttopic.asp">
  <table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr> 
      <td><table width="100%" border="0" cellspacing="0" cellpadding="3">
          <tr>
            <td bgcolor="#6699cc"><font color="#ffffff" size="3" face="Arial, Helvetica, sans-serif"><strong>Add 
              Topic</strong></font></td>
          </tr>
        </table></td>
    </tr>
    <tr> 
      ...
      <td><table width="100%" border="0" cellspacing="0" cellpadding="3">
          ...
          <tr> 
            <td><font size="1" face="Arial, Helvetica, sans-serif">Title<br>
              <input name="chrTitle" type="text" id="chrTitle" size="50" maxlength="75">
              </font></td>
          </tr>
          <tr> 
            <td><font size="1" face="Arial, Helvetica, sans-serif">Description<br>
              <textarea name="txtMessage" cols="50" rows="15" wrap="VIRTUAL" id="txtMessage"></textarea>
              </font></td>
          </tr>
          <tr> 
            <td height="20">&nbsp;</td>
          ...
          <tr> 
            <td><input name="Submit" type="submit" onClick="YY_checkform('form1','chrTitle','#q','0','Please type a topic.','idType','#q','1','Please choose a Type.','idPriority','#q','1','Please choose a Priority.');return document.MM_returnValue" value="Submit Topic"></td>
          </tr>
        </table></td>
    </tr>
    <tr> 
