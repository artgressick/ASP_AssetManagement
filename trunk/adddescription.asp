...
<form name="form1" method="post" action="insertdescription.asp">
            ...
            <td width="610"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr> 
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="3">
                      <tr> 
                        <td width="50%"><font size="3" face="Arial, Helvetica, sans-serif"><strong>Add Description</strong></font></td>
                        <td width="50%">&nbsp;</td>
                      </tr>
                      <tr bgcolor="#f5f5f5"> 
                        <td colspan="2"><font size="1" face="Arial, Helvetica, sans-serif">To add a description, please enter all of the information below and click the Add Description Button.</font></td>
                      </tr>
                    </table></td>
                </tr>
                <tr> 
                  ...
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="3">
                      <tr> 
                        <td><font size="1" face="Arial, Helvetica, sans-serif">Item Number<br>
                          <input name="chrItemNo" type="text" id="chrItemNo" size="17" maxlength="15"></font></td>
                      </tr>
                      <tr> 
                        <td><font size="1" face="Arial, Helvetica, sans-serif">Item Name (example: PowerBook 17&quot; or IBM T - Series Laptop)<br>
                          <input name="chrItem" type="text" id="chrItem" size="50" maxlength="100"></font></td>
                      </tr>
                      <tr> 
...
%>
                            <option value="<%=rsCategories("idCategory")%>"><%=trim(rsCategories("chrCategory"))%></option>
<%
...
%>
                            <option value="<%=rsPictures("idPicture")%>"><%=trim(rsPictures("chrName"))%></option>
<%
		rsPictures.MoveNext
		loop
	end if
                ...
                <tr> 
                  <td bgcolor="#f5f5f5">
					<table width="100%" border="0" cellspacing="0" cellpadding="3">
                      <tr> 
                        <td><font size="2" face="Arial, Helvetica, sans-serif"><strong><font color="#FF0000">Only use the section if the description is a computer.
                        Leave blank for all other items</font>.</strong></font></td>
                      </tr>
                      <tr> 
                      ...
                      <tr> 
                        <td><font size="1" face="Arial, Helvetica, sans-serif">Removeable Storage/Second Optical Drive (example: Iomega ZIP 250MB or DVD-RAM)<br>
                          <input name="chrRStorage" type="text" id="chrRStorage" size="30" maxlength="30"></font></td>
                      </tr>
                      <tr> 
                        <td><font size="1" face="Arial, Helvetica, sans-serif">SCSI/Fibre Channel Device (example: Adaptec Ultra160 PCI or Fibre Channel PCI)<br>
                          <input name="chrSCSI" type="text" id="chrSCSI" size="30" maxlength="25"></font></td>
                      </tr>
                      <tr> 
                        <td><font size="1" face="Arial, Helvetica, sans-serif">Graphics Card (example: ATI Radeon 9700 Pro w/128MB DDR or nVidia Titanium w/128MB DDR)<br>
                          <input name="chrGraphics" type="text" id="chrGraphics" size="30" maxlength="25"></font></td>
                      </tr>
                      <tr> 
                      ...
                      <tr> 
                        <td><font size="1" face="Arial, Helvetica, sans-serif">FireWire (example: 2 FireWire 800 or 2 FireWire 400) make sure to put the version of FireWire!!<br>
                          <input name="chrFireWire" type="text" id="chrFireWire" size="30" maxlength="25"></font></td>
                      </tr>
                      <tr> 
                        <td><font size="1" face="Arial, Helvetica, sans-serif">Ethernet (example: 10/100/1000 Ethernet LAN)<br>
                          <input name="chrEthernet" type="text" id="chrEthernet" size="30" maxlength="30"></font></td>
                      </tr>
                      <tr> 
                        <td><font size="1" face="Arial, Helvetica, sans-serif">Operating System (example: Windows XP Professional, Mac OS X Server or Mac OS 9/10 Dual Boot)<br>
                          <input name="chrOS" type="text" id="chrOS" size="35" maxlength="35"></font></td>
                      </tr>
                      <tr> 
                        <td height="20" bgcolor="#ffffff"><img src="images/ffffffdot.gif" width="1" height="1"></td>
                      </tr>
                      <tr> 
                        <td bgcolor="#ffffff"><input name="Submit" type="submit" id="Submit" onClick="YY_checkform('form1','chrItemNo','#q','0','Please enter the Item Number.','chrItem','#q','0','Please enter the Item Name.');return document.MM_returnValue" value="Add Description"></td>
                      </tr>
                    </table></td>
                </tr>
                <tr>
