...
<form name="form1" method="post" action="loadcartin.asp">
			  ...
			  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td>
                      ...
                      <tr>
                        <td><font size="3" face="Arial, Helvetica, sans-serif"><strong>Check in Assets</strong></font></td>
                      </tr>
                      <tr>
                        <td bgcolor="#f5f5f5"><font size="1" face="Arial, Helvetica, sans-serif">To begin checking in Asset please first choose the Cart and Warehouse then select the continue button to begin scanning assets. This will change the status of the Cart to Pulling Equipment. You will be able to print a list of Assets and Shipping Invoices on the next screen.</font></td>
                      </tr>
                    </table>
				  </td>
                </tr>
