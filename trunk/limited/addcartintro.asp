      ...
      <td width="780"><table width="780" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr> 
            <td><table width="100%" border="0" cellspacing="0" cellpadding="3">
                <tr> 
                  <td width="50%"><font size="3" face="Arial, Helvetica, sans-serif"><strong>Add New Cart</strong></font></td>
          ...
          <tr> 
            <td><table width="100%" border="0" cellspacing="0" cellpadding="3">
                <tr> 
                  <td bgcolor="#f5f5f5"><font size="1" face="Arial, Helvetica, sans-serif">From the drop-down list below, please select the Customer / Pool for whom you would like to create a cart. Then click the Continue button.</font></td>
                </tr>
              </table></td>
          </tr>
          <tr> 
...
%>
          ...
          <tr> 
            <td><table width="100%" border="0" cellspacing="0" cellpadding="3">
                <tr>
                  <td><input name="Submit" type="submit" onClick="YY_checkform('form1','idCustomer','#q','1','Please choose a customer/pool.');return document.MM_returnValue" value="Continue">
