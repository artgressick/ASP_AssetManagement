      ...
      <td width="780"><table width="780" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr> 
            <td><table width="100%" border="0" cellspacing="0" cellpadding="5">
                <tr> 
                  <td align="center"><p><font size="3" face="Arial, Helvetica, sans-serif" color="#FF0000"><b>CART SUCCESS</b></font></p>
                  <p><font size="2" face="Arial, Helvetica, sans-serif">Your Cart has been successfully entered and your first cart has been created.</font></p>
