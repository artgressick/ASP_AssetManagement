      ...
      <td width="780"><table width="780" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr> 
          <td><table width="100%" border="0" cellspacing="0" cellpadding="3">
              <tr> 
                <td width="50%"><font size="4" face="Arial, Helvetica, sans-serif"><strong>Add Cart - Successful</strong></font></td>
          ...
          <td><table width="100%" border="0" cellspacing="0" cellpadding="3">
              <tr> 
                <td bgcolor="#f5f5f5"><font size="1" face="Arial, Helvetica, sans-serif">You 
                  have successfully added this cart. Please do not go back to make 
                  changes as a duplicate cart will be created. If you need to make 
          ...
          <td><table width="100%" border="0" cellspacing="0" cellpadding="3">
              <tr> 
                <td align="center"><font color="#6699cc" size="3" face="Arial, Helvetica, sans-serif"><strong>Now 
                  that you have successfully added this cart you can do the following:</strong></font></td>
              </tr>
              <tr> 
                <td height="30"><img src="images/ffffffdot.gif" width="1" height="1"></td>
              </tr>
              <tr> 
                <td align="center"><font size="2" face="Arial, Helvetica, sans-serif"><a href="loadorder.asp?idOrder=<%=request("idOrder")%>">Add assets to this Cart</a></font></td>
              </tr>
              <tr> 
