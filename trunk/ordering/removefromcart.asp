...
<%
	...
	sql = "execute CountInCartbyDescriptionandCartID " & request("idDescription") & "," & session("idCart")
...
<form name="form1" method="post" action="deletefromcart.asp">
          ...
          <tr bgcolor="#ffffff"> 
            <td width="600" valign="top" bgcolor="#ffffff">
			  <table width="100%" border="0" cellspacing="0" cellpadding="5">
                <tr> 
                  <td><font size="3" face="Arial, Helvetica, sans-serif"><strong>Remove from Cart</strong></font></td>
                </tr>
                <tr> 
                  <td>
					<table width="100%" border="0" cellspacing="0" cellpadding="3">
                      <tr> 
                        <td bgcolor="#f5f5f5"><font size="1" face="Arial, Helvetica, sans-serif">To remove assets from this cart, please select the number of assets you wish to remove and then click on the Update Cart button below.   Your information will be saved and the cart will be updated.</font></td>
                      </tr>
                    </table>
                  </td>
                </tr>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="1">
                      <tr>
                        <td bgcolor="#5b5b5b">
						  <table width="100%" border="0" cellspacing="0" cellpadding="3">
                            <tr>
                              <td align="center" bgcolor="#f5f5f5"><font size="2" face="Arial, Helvetica, sans-serif"><strong>Sorry but there are no Assets to Remove.</strong></font></td>
                            </tr>
                          </table>
                        </td>
                      </tr>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="1">
                      <tr>
                        <td bgcolor="#5b5b5b">
						  <table width="100%" border="0" cellspacing="0" cellpadding="3">
                            <tr>
                              <td align="center" bgcolor="#f5f5f5"><font size="2" face="Arial, Helvetica, sans-serif"><strong>Please remove&nbsp; 
                                <select name="intQuantity" size="1" id="intQuantity">
<%
		for i = 1 to rsAssets("intQuantity")
%>
                                  <option value="<%=i%>"><%=i%></option>
<%
		next
%>
                                </select> asset(s) from my cart.</strong>&nbsp;&nbsp;<input type="hidden" name="idDescription" value="<%=request("idDescription")%>">
            ...
            <td width="200" valign="top" bgcolor="#f5f5f5">
			  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr bgcolor="#6699cc"> 
                  ...
                  <td width="100%" height="20"><font color="#FFFFFF" size="1" face="Arial, Helvetica, sans-serif">&nbsp;Item</font></td>
                </tr>
<%
...
%>
                <tr bgcolor="#6699cc"> 
                  ...
                  <td width="100%" height="20"><font color="#FFFFFF" size="1" face="Arial, Helvetica, sans-serif">&nbsp;Total Requested</font></td>
                </tr>
                <tr> 
