...
<%
	...
	sql = "execute ListCategoriesbyCustomer " & rsCart("idCustomer")
	...
	'create a new SP for this. DO NOT modify this SP it is being used by Inventory.asp
	set rsDescriptions = server.CreateObject("adodb.recordset")
	sql = "execute ListDescriptionswithWhatsAvailableCount2 " & idCategory & "," & session("idCart") & "," & rsCart("idCustomer")
