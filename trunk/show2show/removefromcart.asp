                ...
                <tr> 
                  <td>
					<table width="100%" border="0" cellspacing="0" cellpadding="3">
                      <tr> 
                        <td bgcolor="#f5f5f5"><font size="1" face="Arial, Helvetica, sans-serif">Using the Checkboxes, please select the assets you would like to remove from your Cart. &nbsp;Then click the Remove from Cart button at the bottom of the page. Your information will be saved and the cart will be updated.</font></td>
                      </tr>
                      </tr>
                    </table>
                  </td>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="1">
                      <tr>
                        <td bgcolor="#5b5b5b">
						  <table width="100%" border="0" cellspacing="0" cellpadding="3">
                            <tr>
                              <td align="center" bgcolor="#f5f5f5"><font size="2" face="Arial, Helvetica, sans-serif"><strong>Sorry but there are no <%=trim(rsDescription("chrItem"))%>s in your Cart at this time.</strong><br>
							      <font size="1">Please use the <font color="#FF0000">"Back"</font> Button in your browser to continue removing assets from this cart.</font></font></td>
                            </tr>
                          </table>
                        </td>
                      </tr>
...
%>
				...
				<tr> 
                  <td><input type="submit" name="Submit" value="Remove from Cart">&nbsp;&nbsp;<input type="reset" value="Clear Selected" name="Reset">
