...
<%
	...
	sql = "execute ListShow2ShowCategories " & session("idLinkedCart")
	...
	sql = "execute ListShow2ShowDescriptionsbyCategory " & session("idLinkedCart") & "," & session("idCart") & "," & idCategory
	'sql = "execute ListDescriptionswithWhatsAvailableCountNoPadding " & idCategory & "," & session("idCart") & "," & rsCart("idCustomer")
          ...
          <tr bgcolor="#ffffff"> 
            <td width="600" valign="top" bgcolor="#ffffff">
			  <table width="100%" border="0" cellspacing="0" cellpadding="5">
                <tr> 
                  <td><font size="3" face="Arial, Helvetica, sans-serif"><strong>Cart Name: <%=trim(rsCart("chrCart"))%> <%=session("idLinkedCart")%>/<%=session("idCart")%></strong></font></td>
                </tr>
                <tr> 
                  <td>
