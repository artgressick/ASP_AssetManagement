                ...
                <tr> 
                  <td>
					<table width="100%" border="0" cellspacing="0" cellpadding="3">
                      <tr> 
                        <td bgcolor="#f5f5f5"><font size="1" face="Arial, Helvetica, sans-serif">Listed below is a summary of the Assets that you have requested. 
                          Please ensure that your choices are accurate before you submit your cart to the Pool Manager.<br>
						  <font color="#FF0000">Once you Submit your cart it will be locked and no assets can be added or removed except by the Pool Manager
                          or techIT Account Manager.</font><br>
						  If you decide to exit the shopping cart all information will be saved until you review and submit the order. 
                          Please note that Carts expire in three days from creation unless submitted or approved. If you have any questions please contact the Pool Manager or techIT Solutions.</font></td>
                      </tr>
                    </table>
                  </td>
                </tr>
                  ...
                  <td>
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr bgcolor="#6699cc"> 
                        ...
                        <td height="20" align="center"><font color="#FFFFFF" size="1" face="Arial, Helvetica, sans-serif">Qty</font></td>
...
%>
                      <tr> 
                        <td height="20" colspan="5" align="center"><font size="1" face="Arial, Helvetica, sans-serif">There is nothing in your cart at this time.</font></td>
                      </tr>
                      <tr> 
