...
<%
	...
	sql = "execute ListCartsPreArrivalbyManager " & session("idUser")
	...
	sql = "execute ListCartsReturningbyManager " & session("idUser")
            ...
            <td width="610"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr> 
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="3">
                      <tr> 
                        <td><font size="3" face="Arial, Helvetica, sans-serif"><strong>Pool Manager Dashboard</strong></font></td>
                      </tr>
                      <tr> 
                ...
                <tr> 
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr bgcolor="#6699cc"> 
                        ...
                        &nbsp;Carts in <font color="#ff0000">RED</font> have not been approved and are within 1 day of shipping.</font></font></td>
                      </tr>
                      <tr bgcolor="#c0c0c0"> 
                ...
                <tr> 
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr> 
                        ...
                        <font size="1">&nbsp;Carts in <font color="#ffff00">YELLOW</font> should be have arrived at the warehouse but have not.<br>
                        &nbsp;Carts in <font color="#ff0000">RED</font> are 3 days past due.</font></font></td>
                      </tr>
                      <tr> 
