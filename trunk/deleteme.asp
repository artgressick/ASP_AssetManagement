          ...
          <tr>
            ...
            <td width="610"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr> 
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="3">
                      <tr> 
                        <td width="50%"><font color="#FF0000" size="2">*</font><font color="#000000" size="1" face="Arial, Helvetica, sans-serif">Arrival Date (example: 01/01/2003)</font><font size="1" face="Arial, Helvetica, sans-serif"><br>
                          <input name="dtArrival" type="text" id="dtArrival" size="12" maxlength="10" tabindex="7">&nbsp;&nbsp;<a href="#" onClick="YY_Calendar('dtArrival',335,330,'de','#000000','#f5f5f5','YY_calendar1')"><img src="images/calendar.gif" width="34" height="21" border="0"></a></font></td>
                        <td width="50%"><font color="#FF0000" size="2">*</font><font color="#000000" size="1" face="Arial, Helvetica, sans-serif">End / Departure Date (example: 01/01/2003)</font><font size="1" face="Arial, Helvetica, sans-serif"><br>
                          <input name="dtDeparture" type="text" id="dtDeparture" size="12" maxlength="10" tabindex="9">&nbsp;&nbsp;<a href="#" onClick="YY_Calendar('dtDeparture',387,330,'de','#000000','#f5f5f5','YY_calendar1')"><img src="images/calendar.gif" width="34" height="21" border="0"></a></font></td>
                      </tr>
                      <tr> 
...
%>
                ...
                <tr> 
                  <td>
					<table width="100%" border="0" cellspacing="0" cellpadding="3">
					  <tr> 
						<td><font size="1" face="Arial, Helvetica, sans-serif">Please put any special needs, setup notes or anything that you need the warehouse to know in the space below. You can add more notes to this order at anytime.<br>
...
%>
                <tr> 
                  <td><input name="Submit" type="submit" tabindex="37" onClick="YY_checkform('form1','idSaveAddress','chrSavedAddressName','2','Please enter a Name for the Saved Address.',<%=addressjavastring%><%=carrierjavastring%>'chrOrder','#q','0','Please enter the Order Name.','chrDDName','#q','0','Please enter the Division/Department Name.','chrDDNumber','#q','0','Please enter the Division/Department Number.','chrOSPerson','#q','0','Please enter an On-Site Contact Name.','chrOSPhone','#q','0','Please enter an On-Site Phone number.','chrOSEmail','#q','0','Please enter an On-Site Email address.');return document.MM_returnValue" value="Create Order">
