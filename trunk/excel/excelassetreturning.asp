...
<%
	...
	file_being_created= "AssetsReturning.xls"
	...
	act.WriteLine("<th nowrap>Arrival</th>")
	act.WriteLine("<th nowrap>Departure</th>")
	act.WriteLine("</tr>")
	...
	if not rsInventory.EOF then
		do until rsInventory.EOF
			...
			act.WriteLine("<td align=""right"">" & formatdatetime(rsInventory("dtArrival"),2) & "</td>" )
			act.WriteLine("<td align=""right"">" & formatdatetime(rsInventory("dtDeparture"),2) & "</td>" )
			act.WriteLine("</tr>")
...
<table width="300" height="275" border="0" cellpadding="7" cellspacing="0">
  ...
  <tr> 
    <td align="center"><font size="2" face="Arial, Helvetica, sans-serif"><strong>Excel 
      File: <a href="AssetsReturning.xls">Assets Returning Report</a></strong></font></td>
  </tr>
</table>
</body>
</html>