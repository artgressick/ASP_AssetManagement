...
<%
	...
	file_being_created= "FutureActivity.xls"
	...
	act.WriteLine("<tr>")
	act.WriteLine("<th nowrap>Asset Number</th>")
	act.WriteLine("<th nowrap>Item</th>")
	act.WriteLine("<th nowrap>Order/Location</th>")
	act.WriteLine("<th nowrap>Pull Date</th>")
	act.WriteLine("<th nowrap>Turn Date</th>")
	act.WriteLine("</tr>")
	...
	if not rsInventory.EOF then
		do until rsInventory.EOF
			...
			act.WriteLine("<td align=""right"">" & formatdatetime(rsInventory("dtPull"),2) & "</td>" )
			act.WriteLine("<td align=""right"">" & formatdatetime(rsInventory("dtTurn"),2) & "</td>" )
			act.WriteLine("</tr>")
...
<table width="300" height="275" border="0" cellpadding="7" cellspacing="0">
  ...
  <tr>
    <td align="center"><font size="2" face="Arial, Helvetica, sans-serif"><strong>Excel
      File: <a href="FutureActivity.xls">Future Activity Report</a></strong></font></td>
  </tr>
</table>
</body>
</html>
