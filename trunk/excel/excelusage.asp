...
<%
	...
	sql = "execute ListUsageReport " & idCustomer & "," & idCategory & ",'" & dtPull & "','" & dtTurn & "'"
	set rsInventory = dbConnection.Execute(sql)
	totaldays = datediff("d",dtPull,dtTurn)
	
	'Name for the ouput document
	file_being_created= "CustomerUsage.xls"
	...
	act.WriteLine("<th nowrap>Usage</th>")
	act.WriteLine("</tr>")
	...
	if not rsInventory.EOF then
		do until rsInventory.EOF
			...
			act.WriteLine("<td align=""right"">" & singlestats & "</td>" )
			act.WriteLine("</tr>")
...
<table width="300" height="275" border="0" cellpadding="7" cellspacing="0">
  ...
  <tr>
    <td align="center"><font size="2" face="Arial, Helvetica, sans-serif"><strong>Excel
      File: <a href="CustomerUsage.xls">Customer Usage Report</a></strong></font></td>
  </tr>
</table>
</body>
</html>