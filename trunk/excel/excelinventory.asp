...
<%
	...
	file_being_created= "InventoryReport.xls"
	...
	act.WriteLine("<th nowrap>Owner</th>")
	act.WriteLine("</tr>")
	...
	if not rsInventory.EOF then
		do until rsInventory.EOF
			...
			select case trim(rsInventory("idOwner"))
				case 1
					chrOwner = "Pool"
				case 2
			...
			act.WriteLine("<td align=""right"">"& chrOwner & "</td>")
			act.WriteLine("</tr>")
...
<table width="300" height="275" border="0" cellpadding="7" cellspacing="0">
  ...
  <tr> 
    <td align="center"><font size="2" face="Arial, Helvetica, sans-serif"><strong>Excel 
      File: <a href="InventoryReport.xls">Inventory Report</a></strong></font></td>
  </tr>
</table>
</body>
</html>
