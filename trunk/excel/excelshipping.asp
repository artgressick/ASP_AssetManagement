...
<%
	...
	file_being_created= "CartsShipping.xls"
	...
	act.WriteLine("<tr>")
	act.WriteLine("<th nowrap>Cart</th>")
	act.WriteLine("<th nowrap>Customer</th>")
	act.WriteLine("<th nowrap>Urgency</th>")
	...
	if not rsCarts.EOF then
		do until rsCarts.EOF
			...
			act.WriteLine("<td align=""right"">" & ergency & "</td>" )
			act.WriteLine("<td align=""right"">" & trim(rsCarts("chrCartStatus")) & "</td>" )
			act.WriteLine("<td align=""right"">" & formatdatetime(rsCarts("dtShip"),2) & "</td>" )
  ...
  <tr>
    <td><p><font size="2" face="Arial, Helvetica, sans-serif"><strong>Directions</strong>:
      ...
      <p><font size="2" face="Arial, Helvetica, sans-serif"><strong>Using a 1-button
        mouse</strong>: Holding down the &quot;Control&quot; key click on the link below and &quot;Download Link to Disk&quot;.</font></p></td>
  </tr>
  <tr>
    <td align="center"><font size="2" face="Arial, Helvetica, sans-serif"><strong>Excel File: <a href="CartsShipping.xls">Carts Shipping Report</a></strong></font></td>
  </tr>
</table>
</body>
</html>
