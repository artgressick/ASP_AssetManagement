...
<%
	...
	file_being_created= "OrderCartMonthly.xls"
	...
	act.WriteLine("<th nowrap>Reconfigured</th>")
	act.WriteLine("<th nowrap>Special Load</th>")
	act.WriteLine("<th nowrap>Delivery Type</th>")
	...
	if not rsCarts.EOF then
		do until rsCarts.EOF
			...
			act.WriteLine("<td align=""right"">" & trim(rsCarts("intAssets")) & "</td>" )
			act.WriteLine("<td align=""right"">" & trim(rsCarts("intReconfigured")) & "</td>" )
			act.WriteLine("<td align=""right"">" & trim(rsCarts("chrSpecialLoad")) & "</td>" )
			...
			act.WriteLine("<td align=""right"">" & Expedite & "</td>" )
...
<table width="300" height="275" border="0" cellpadding="7" cellspacing="0">
  ...
  <tr>
    <td align="center"><font size="2" face="Arial, Helvetica, sans-serif"><strong>Excel
      File: <a href="OrderCartMonthly.xls">Order/Cart Monthly Report</a></strong></font></td>
  </tr>
</table>
</body>
</html>
