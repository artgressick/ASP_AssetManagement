...
<%
	...
	file_being_created= "OutofSystem.xls"
	...
	if not rsInventory.EOF then
		do until rsInventory.EOF
			...
			act.WriteLine("<td align=""right"">" & formatdatetime(rsInventory("dtOut"),2) & "</td>" )
			act.WriteLine("</tr>")
...
<table width="300" height="275" border="0" cellpadding="7" cellspacing="0">
  ...
  <tr>
    <td align="center"><font size="2" face="Arial, Helvetica, sans-serif"><strong>Excel
      File: <a href="OutofSystem.xls">Assets Out of System Report</a></strong></font></td>
  </tr>
</table>
</body>
</html>
