...
<form name="form1" method="post" action="show2show.asp">
                ...
                <tr> 
                  <td>
					<table width="100%" border="0" cellspacing="0" cellpadding="3">
                      <tr> 
                        <td width="50%"><font size="3" face="Arial, Helvetica, sans-serif"><strong>Show to Show Order Process</strong></font></td>
                        <td width="50%">&nbsp;</td>
                      </tr>
                      <tr bgcolor="#f5f5f5"> 
						...
						The table below will list any carts in this order. This process will allow you to order assets from show to show by the Arrival and Departure dates.</font></td>
                      </tr>
                    </table>
                  </td>
                </tr>
...
%>
                      <tr> 
                        ...
                        <td height="20" align="right"><font size="1" face="Arial, Helvetica, sans-serif"><%if session("idAccess") < "P" and (rsCarts("idStatus") = 3 or rsCarts("idStatus") = 2) then%><a href="unlockcart.asp?idCart=<%=rsCarts("idCart")%>&idOrder=<%=idOrder%>">Unlock</a><%end if%><%if rsCarts("idStatus") = 1 then%><a href="show2show/loadcart.asp?idCart=<%=rsCarts("idCart")%>">Open Cart</a><%end if%></font></td>
                      </tr>
                      <tr bgcolor="#5b5b5b"> 
                        <td height="1" colspan="4"><img src="images/5b5b5bdot.gif" width="1" height="1"></td>
                      </tr>
