...
<%
	...
	if flag = 0 then
		...
		if session("idAccess") < "O" then
			sql = "execute ListLesaReport2 " & idCustomer & ",'" & request("dtPull") & "','" & request("dtTurn") & "'"
		else
			sql = "execute ListLesaReport2byAccess " & idCustomer & "," & session("idUser") & ",'" & request("dtPull") & "','" & request("dtTurn") & "'"
		end if
...
<form name="form1" method="post" action="reportlesa2.asp">
            ...
            <td width="100%"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr> 
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="3">
                      <tr> 
                        <td><font size="3" face="Arial, Helvetica, sans-serif"><strong>Order / Cart Monthly Report</strong></font></td>
                      </tr>
                    </table></td>
                </tr>
                <tr>
                  ...
                  <td>
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td height="20" bgcolor="#c0c0c0" colspan="8">
                          <table width="100%" border="0" cellspacing="0" cellpadding="5">
                            <tr>
                              <td align="left"><a HREF="javascript:newWindow('excel/excellesa2.asp?idCustomer=<%=idCustomer%>&dtPull=<%=request("dtPull")%>&dtTurn=<%=request("dtTurn")%>')"><img SRC="images/exporttoexcel.gif" border="0" WIDTH="120" HEIGHT="19"></a></td>
                            </tr>
                          </table>
                        </td>
                      </tr>
                      <tr> 
                        ...
                        <td height="20" bgcolor="#6699cc"><font color="#FFFFFF" size="1" face="Arial, Helvetica, sans-serif">&nbsp;Delivery Type</font></td>
...
%>
                      <tr bgcolor="<%=bgcolor%>"> 
                        ...
                        <td height="20"><font size="1" face="Arial, Helvetica, sans-serif">&nbsp;<%=trim(rsCarts("intAssets"))%></font></td>
...
%>
                        <td height="20"><font size="1" face="Arial, Helvetica, sans-serif">&nbsp;<%=Expedite%></font></td>
