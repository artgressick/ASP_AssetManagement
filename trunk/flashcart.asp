      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr> 
          <td colspan="3"> <table width="100%" border="0" cellspacing="0" cellpadding="3">
              <tr bgcolor="#5b5b5b"> 
                <td bgcolor="#5b5b5b"><font color="#ffffff" size="3" face="Arial, Helvetica, sans-serif"><strong>Cart 
                  Detail: <%=trim(rsCart("chrCart"))%></strong></font></td>
              </tr>
            </table></td>
        </tr>
        <tr> 
          <td width="100%" valign="top"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr> 
                <td bgcolor="#c0c0c0"><table width="100%" border="0" cellspacing="1" cellpadding="3">
                    <tr align="center"> 
                      <td><font size="1" face="Arial, Helvetica, sans-serif">Last 
                        Updated</font></td>
                      <td><font size="1" face="Arial, Helvetica, sans-serif">Tech 
                        Support?</font></td>
                      <td><font size="1" face="Arial, Helvetica, sans-serif">Loaner 
                        Agreement</font></td>
...
%>
              ...
              <tr> 
                <td bgcolor="#c0c0c0"><table width="100%" border="0" cellspacing="1" cellpadding="3">
                    <tr align="center"> 
                      <td><font size="1" face="Arial, Helvetica, sans-serif">Order 
                        Type</font></td>
                      <td><font size="1" face="Arial, Helvetica, sans-serif">Apple 
                        Requestor</font></td>
                    </tr>
                    <tr align="center"> 
                      <%
          ...
          <td colspan="3"> <table width="100%" border="0" cellspacing="0" cellpadding="1">
              <tr> 
                <td bgcolor="#c0c0c0"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td height="20"><font size="1" face="Arial, Helvetica, sans-serif">&nbsp;Asset 
                        #</font></td>
                      <td height="20"><font size="1" face="Arial, Helvetica, sans-serif">&nbsp;Item 
                        Description</font></td>
                      <td height="20"><font size="1" face="Arial, Helvetica, sans-serif">&nbsp;Requested 
                        by</font></td>
...
%>
                    <tr align="center"> 
                      <td height="20" colspan="6" bgcolor="#ffffff"><font size="1" face="Arial, Helvetica, sans-serif">No 
                        Assets have been requested at this time.</font></td>
                    </tr>
                    <%
	else
...
%>
        ...
        <td bgcolor="#c0c0c0" colspan="3"> <table width="100%" border="0" cellspacing="1" cellpadding="3">
            <tr> 
              <td><font size="1" face="Arial, Helvetica, sans-serif">Purpose of 
                Loan</font></td>
            </tr>
            <tr bgcolor="ffffff"> 
        ...
        <td bgcolor="#c0c0c0" colspan="3"> <table width="100%" border="0" cellspacing="1" cellpadding="3">
            <tr> 
              <td><font size="1" face="Arial, Helvetica, sans-serif">Notes and 
        ...
        <tr> 
          <td bgcolor="#c0c0c0" colspan="3"> <table width="100%" border="0" cellspacing="1" cellpadding="3">
              <tr> 
                ...
                <td><font size="1" face="Arial, Helvetica, sans-serif">Return 
                  VIA</font></td>
              ...
              <tr valign="top" bgcolor="#ffffff"> 
                ...
                <td colspan="2"><font size="2" face="Arial, Helvetica, sans-serif"><strong>Return:</strong></font><br> 
                  <font size="1" face="Arial, Helvetica, sans-serif"><%=trim(rsWarehouse("chrWarehouse"))%> 
                  Warehouse<br>
                ...
                <td colspan="2"><font size="2" face="Arial, Helvetica, sans-serif"><strong>Bill 
                  To:</strong></font><br> <font size="1" face="Arial, Helvetica, sans-serif"><%=trim(rsCart("chrCustomer"))%><br>
