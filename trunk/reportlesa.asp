...
<form name="form1" method="post" action="reportlesa.asp">
            ...
            <td width="100%"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr> 
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="3">
                      <tr> 
                        <td><font size="3" face="Arial, Helvetica, sans-serif"><strong>Order / Cart Information Report</strong></font></td>
                      </tr>
                    </table></td>
                </tr>
                <tr>
                        ...
                        <td bgcolor="#c0c0c0">
                          <table width="100%" border="0" cellspacing="0" cellpadding="3">
                            <tr bgcolor="#f5f5f5"> 
                              ...
                              <td><font size="1" face="Arial, Helvetica, sans-serif"><input name="dtPull" type="text" id="dtPull" size="10" maxlength="10" value="<%=request("dtPull")%>">&nbsp;&nbsp;<a href="#" onClick="YY_Calendar('dtPull',250,160,'de','#000000','#f5f5f5','YY_calendar1')"><img src="images/calendar.gif" width="34" height="21" border="0"></a></font></td>
                              <td align="right"><font size="1" face="Arial, Helvetica, sans-serif">End Date</font></td>
                              <td><font size="1" face="Arial, Helvetica, sans-serif"><input name="dtTurn" type="text" id="dtTurn" size="10" maxlength="10" value="<%=request("dtTurn")%>">&nbsp;&nbsp;<a href="#" onClick="YY_Calendar('dtTurn',475,160,'de','#000000','#f5f5f5','YY_calendar1')"><img src="images/calendar.gif" width="34" height="21" border="0"></a></font></td>
                              <td align="right"><font size="1" face="Arial, Helvetica, sans-serif">Customer</font></td>
                  ...
                  <td>
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td height="20" bgcolor="#c0c0c0" colspan="8">
                          <table width="100%" border="0" cellspacing="0" cellpadding="5">
                            <tr>
                              <td align="left"><a HREF="javascript:newWindow('excel/excellesa.asp?idCustomer=<%=idCustomer%>&dtPull=<%=request("dtPull")%>&dtTurn=<%=request("dtTurn")%>')"><img SRC="images/exporttoexcel.gif" border="0" WIDTH="120" HEIGHT="19"></a></td>
                            </tr>
                          </table>
                        </td>
                      </tr>
                      <tr> 
                        ...
                        <td height="20" bgcolor="#6699cc"><font color="#FFFFFF" size="1" face="Arial, Helvetica, sans-serif">&nbsp;Bill To</font></td>
                        <td height="20" bgcolor="#6699cc"><font color="#FFFFFF" size="1" face="Arial, Helvetica, sans-serif">&nbsp;Department/Division</font></td>
                        <td height="20" bgcolor="#6699cc"><font color="#FFFFFF" size="1" face="Arial, Helvetica, sans-serif">&nbsp;Inv Email</font></td>
                        <td height="20" bgcolor="#6699cc"><font color="#FFFFFF" size="1" face="Arial, Helvetica, sans-serif">&nbsp;Status</font></td>
                        <td height="20" bgcolor="#6699cc"><font color="#FFFFFF" size="1" face="Arial, Helvetica, sans-serif">&nbsp;Ship</font></td>
                        <td height="20" bgcolor="#6699cc"><font color="#FFFFFF" size="1" face="Arial, Helvetica, sans-serif">&nbsp;Return</font></td>
                        <td height="20" bgcolor="#6699cc"><font color="#FFFFFF" size="1" face="Arial, Helvetica, sans-serif">&nbsp;Billed</font></td>
                      </tr>
                      <tr bgcolor="#c0c0c0"> 
...
%>
                      <tr> 
                        <td height="20" align="center" colspan="8"><font size="1" face="Arial, Helvetica, sans-serif">&nbsp;Order Name</font></td>
                      </tr>
                      <tr bgcolor="#c0c0c0"> 
                        <td height="1" colspan="8"><img src="images/c0c0c0dot.gif" width="1" height="1"></td>
                      </tr>
...
%>
                      <tr bgcolor="<%=bgcolor%>"> 
                        <td height="20"><font size="1" face="Arial, Helvetica, sans-serif">&nbsp;<A HREF="viewcart.asp?idCart=<%=rsCarts("idCart")%>"><%=trim(rsCarts("chrCart"))%></A></font></td>
<%
...
%>
                        <td height="20"><font size="1" face="Arial, Helvetica, sans-serif">&nbsp;<%=Billto%></font></td>
                        <td height="20"><font size="1" face="Arial, Helvetica, sans-serif">&nbsp;<%=trim(rsCarts("chrDDName")) & ": " & trim(rsCarts("chrDDNumber"))%></font></td>
                        <td height="20"><font size="1" face="Arial, Helvetica, sans-serif">&nbsp;<%=trim(rsCarts("chrIEmail"))%></font></td>
                        ...
                        <td height="20"><font size="1" face="Arial, Helvetica, sans-serif">&nbsp;<%=formatdatetime(rsCarts("dtDeparture"),2)%></font></td>
<%
...
%>
                        <td height="20"><font size="1" face="Arial, Helvetica, sans-serif">&nbsp;<%=Billed%></font></td>
                      </tr>
                      <tr bgcolor="#c0c0c0"> 
                        <td height="1" colspan="8"><img src="images/c0c0c0dot.gif" width="1" height="1"></td>
                      </tr>
