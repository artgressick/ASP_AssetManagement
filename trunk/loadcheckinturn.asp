...
<form name="form1" method="post" action="loadcartinturn.asp">
			  ...
			  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td>
                      ...
                      <tr>
                        <td><font size="3" face="Arial, Helvetica, sans-serif"><strong>Check in &amp; Turn Assets</strong></font></td>
                      </tr>
                      <tr>
                        <td bgcolor="#f5f5f5"><p><font size="1" face="Arial, Helvetica, sans-serif">To begin checking in &amp; turning Asset please first choose the Warehouse then select the continue button to begin scanning assets. </font></p>
                        <p><font size="1" face="Arial, Helvetica, sans-serif">Remeber this should not be done on computers, only equipment that can be visually inspected and placed back on the shelf.</font></p></td>
                      </tr>
                    </table>
				  </td>
                </tr>
					  ...
					  <tr>
                        <td><font size="1" face="Arial, Helvetica, sans-serif">Warehouse</font><BR>
                            <font size="1" face="Arial, Helvetica, sans-serif"><select name="idWarehouse" size="1">
                              <option value="0">Please choose a warehouse to begin checkin</option>
<%
