...
<%
	...
	if rsInventory.EOF then
		...
		if rsInventory("idStatus") <> 1 then
			...
			errormessage = "This asset needs to be checked in before you can check it out to lost.<BR>Please check the status and try again."
		else
			errorflag = 0 'AEG - ok
...
<form name="form1" method="post" action="checkoutlost3.asp">
                ...
                <tr> 
                  <td>
					<table width="100%" border="0" cellspacing="0" cellpadding="3">
                      ...
                      <tr> 
                        <td bgcolor="#f5f5f5"><font size="1" face="Arial, Helvetica, sans-serif">Listed below are all of the upcoming shows that this asset
                          will be going to. Please make note that you will have to replace this asset with another if this asset is not found in time for the next order.</font></td>
                      </tr>
                    </table>
                  </td>
                </tr>
