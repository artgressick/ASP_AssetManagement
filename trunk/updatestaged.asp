      ...
      <td bgcolor="#6699cc"><table width="100%" border="0" cellspacing="1" cellpadding="0">
          <tr>
            <td bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="3">
                ...
                <tr> 
                  <td align="center"><font color="#0000FF" size="3" face="Arial, Helvetica, sans-serif"><strong>Cart Shipped</strong></font></td>
                </tr>
                <tr> 
                  <td align="center"><font size="2" face="Arial, Helvetica, sans-serif">The status of this cart has been set to Shipped.<br><br>
				  Please click <a href="shippinginvoice.asp?idCart=<%=request("idCart")%>" target="_blank">here</a> print a shipping manifest.<BR><BR>
