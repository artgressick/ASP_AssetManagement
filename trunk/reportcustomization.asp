...
<%
	...
	if request("dtPull") = "" or request("dtTurn") = "" then
		...
		if session("idAccess") < "O" then
			sql = "execute ListCartsCustomized " & idCustomer & ",'" & request("dtPull") & "','" & request("dtTurn") & "'"
		else
			sql = "execute ListCartsCustomizedbyAccess " & idCustomer & "," & session("idUser") & ",'" & request("dtPull") & "','" & request("dtTurn") & "'"
		end if
...
<form name="form1" method="post" action="reportcustomization.asp">
            ...
            <td width="100%"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr> 
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="3">
                      <tr> 
                        <td><font size="3" face="Arial, Helvetica, sans-serif"><strong>Cart Customization Report</strong></font></td>
                      </tr>
                    </table></td>
                </tr>
                <tr>
                  ...
                  <td>
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td height="20" bgcolor="#c0c0c0" colspan="8">
                          <table width="100%" border="0" cellspacing="0" cellpadding="5">
                            <tr>
                              <td align="left"><a HREF="javascript:newWindow('excel/excelcustomization.asp?idCustomer=<%=idCustomer%>&amp;dtPull=<%=request("dtPull")%>&amp;dtTurn=<%=request("dtTurn")%>')"><img SRC="images/exporttoexcel.gif" border="0" WIDTH="120" HEIGHT="19"></a></td>
                            </tr>
                          </table>
                        </td>
                      </tr>
                      <tr bgcolor="#6699cc"> 
						...
						<td height="20"><font color="#ffffff" size="1" face="Arial, Helvetica, sans-serif">&nbsp;Expedite</font></td>
						<td height="20"><font color="#ffffff" size="1" face="Arial, Helvetica, sans-serif">&nbsp;Reconfigured</font></td>
						<td height="20"><font color="#ffffff" size="1" face="Arial, Helvetica, sans-serif">&nbsp;Special Load?</font></td>
                        <td height="20"><font color="#ffffff" size="1" face="Arial, Helvetica, sans-serif">&nbsp;Arrival Date</font></td>
                        <td height="20"><font color="#ffffff" size="1" face="Arial, Helvetica, sans-serif">&nbsp;Departure Date</font></td>
                        <td height="20"><font color="#ffffff" size="1" face="Arial, Helvetica, sans-serif">&nbsp;Assets</font></td>
                      </tr>
<%
	if rsCarts.EOF then
%>
...
%>
						<td height="20"><font size="1" face="Arial, Helvetica, sans-serif">&nbsp;<%=urgency%></font></td>
						<td height="20"><font size="1" face="Arial, Helvetica, sans-serif">&nbsp;<%=trim(rsCarts("intReconfigured"))%></font></td>
                        <td height="20"><font size="1" face="Arial, Helvetica, sans-serif">&nbsp;<%=trim(rsCarts("chrSpecialLoad"))%></font></td>
...
%>
                      <tr bgcolor="#6699cc"> 
                        <td height="20" colspan="8" align="left"><font color="#ffffff" size="1" face="Arial, Helvetica, sans-serif">&nbsp;Total Carts: <%=counter%></font></td>
                      </tr>
                      <tr bgcolor="#c0c0c0"> 
                        <td height="1" colspan="8"><img src="images/c0c0c0dot.gif" width="1" height="1"></td>
                      </tr>
