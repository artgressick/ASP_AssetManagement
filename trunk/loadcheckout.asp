			  ...
			  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr> 
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="3">
                      <tr>
                        <td width="50%"><font size="3" face="Arial, Helvetica, sans-serif"><strong>Asset Check Out Process</strong></font></td>
                ...
                <tr>
                  <td>
					<table width="100%" border="0" cellspacing="0" cellpadding="3">
                      <tr bgcolor="#f5f5f5">
						<td><font size="1" face="Arial, Helvetica, sans-serif">Listed below are all of the Carts that are ready for Pulling. Please click on the Cart Name to begin the process.<br>
						Once you begin the process it will change the cart status to "Pulling".</font></td>
					  </tr>
					</table>
                  </td>
                </tr>
...
%>
                      <tr> 
                        <td height="20" bgcolor="<%=bgcolor%>"><font size="1" face="Arial, Helvetica, sans-serif">&nbsp;<A HREF="loadcartout.asp?idCart=<%=rsCarts("idCart")%>"><%=trim(rsCarts("chrCart"))%></A></font></td>
